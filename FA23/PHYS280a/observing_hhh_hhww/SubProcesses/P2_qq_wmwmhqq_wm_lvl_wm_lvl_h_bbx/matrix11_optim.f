...
C     ----------
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,19),W(1,2),-GC_50,GC_58,MDL_MZ,ZERO,W(1,23))  !  count 28
      CALL FFV2_5_3(W(1,20),W(1,1),-GC_50,GC_58,MDL_MZ,ZERO,W(1,24))  !  count 24
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV1P0_3(W(1,19),W(1,2),GC_2,ZERO,FK_ZERO,W(1,27))  !  count 16
     ...
     & TMP, W, AMP(1,10))  !  count 1
      CALL FFV1P0_3(W(1,19),W(1,1),GC_2,ZERO,FK_ZERO,W(1,41))  !  count 16
     ...
     & TMP, W, AMP(1,16))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,2), W(1,41), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,20))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,27), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,21))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,23), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,25))  !  count 1
      CALL FFV2_3_3(W(1,18),W(1,37),GC_50,GC_58,MDL_MZ,ZERO,W(1,62))  !  count 24
     ...
     & TMP, W, AMP(1,26))  !  count 1
      ...
      CALL FFV2_5_3(W(1,63),W(1,1),-GC_50,GC_58,MDL_MZ,ZERO,W(1,65))  !  count 28
      CALL FFV2_5_3(W(1,64),W(1,2),-GC_50,GC_58,MDL_MZ,ZERO,W(1,66))  !  count 24
      CALL VVS1P1N_3(W(1,65), W(1,66), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,27))  !  count 1
      CALL FFV2_5_3(W(1,63),W(1,2),-GC_50,GC_58,MDL_MZ,ZERO,W(1,67))  !  count 28
      CALL FFV2_5_3(W(1,64),W(1,1),-GC_50,GC_58,MDL_MZ,ZERO,W(1,68))  !  count 24
     ...
     & TMP, W, AMP(1,29))  !  count 1
      CALL FFV1P0_3(W(1,63),W(1,2),GC_2,ZERO,FK_ZERO,W(1,70))  !  count 16
     ...
     & TMP, W, AMP(1,36))  !  count 1
      CALL FFV1P0_3(W(1,63),W(1,1),GC_2,ZERO,FK_ZERO,W(1,79))  !  count 16
     ...
     & TMP, W, AMP(1,43))  !  count 1
      CALL FFV2_5P1N_1(W(1,2), W(1,65), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,46))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,70), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,47))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,67), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,51))  !  count 1
      CALL FFV2_3_3(W(1,18),W(1,76),GC_50,GC_58,MDL_MZ,ZERO,W(1,96))  !  count 24
     ...
     & TMP, W, AMP(1,53))  !  count 1
      ...
      CALL FFV1P0_3(W(1,64),W(1,2),GC_2,ZERO,FK_ZERO,W(1,103))  !  count 12
     ...
     & TMP, W, AMP(1,60))  !  count 1
      CALL FFV1P0_3(W(1,20),W(1,2),GC_2,ZERO,FK_ZERO,W(1,114))  !  count 12
     ...
     & TMP, W, AMP(1,102))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,129), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,103))  !  count 1
      CALL FFV2_5P1N_1(W(1,2), W(1,98), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,115))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,126), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,116))  !  count 1
      CALL FFV2_5P1N_1(W(1,2), W(1,113), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,123))  !  count 1
      ...
      CALL FFV1P0_3(W(1,64),W(1,1),GC_2,ZERO,FK_ZERO,W(1,159))  !  count 12
     ...
     & TMP, W, AMP(1,126))  !  count 1
      ...
      CALL FFV1P1N_3(W(1,64), W(1,1), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/161,162,163,164/),
     & TMP, W, AMP(1,127))  !  count 1
      ...
      CALL FFV2_5P1N_3(W(1,64), W(1,1), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/165,166,167,168/),
     ...
     & TMP, W, AMP(1,130))  !  count 1
      CALL FFV1P0_3(W(1,20),W(1,1),GC_2,ZERO,FK_ZERO,W(1,170))  !  count 12
     ...
     & TMP, W, AMP(1,133))  !  count 1
      ...
      CALL FFV1P1N_3(W(1,20), W(1,1), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/172,173,174,175/),
     & TMP, W, AMP(1,134))  !  count 1
      ...
      CALL FFV2_5P1N_3(W(1,20), W(1,1), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/176,177,178,179/),
     ...
     & TMP, W, AMP(1,172))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,185), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,173))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,154), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,185))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,182), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,186))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,169), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,192))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,2), W(1,159), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,193))  !  count 1
      CALL FFV2_5P1N_1(W(1,2), W(1,68), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     ...
     & TMP, W, AMP(1,195))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,66), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,196))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,159), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,197))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,68), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,199))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,66), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,200))  !  count 1
      CALL FFV2_3_3(W(1,17),W(1,47),GC_50,GC_58,MDL_MZ,ZERO,W(1,213))  !  count 28
      CALL VVS1P1N_3(W(1,213), W(1,66), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,201))  !  count 1
      CALL FFV2_3_3(W(1,17),W(1,37),GC_50,GC_58,MDL_MZ,ZERO,W(1,214))  !  count 28
     ...
     & TMP, W, AMP(1,202))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,2), W(1,170), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     ...
     & TMP, W, AMP(1,204))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,114), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     ...
     & TMP, W, AMP(1,206))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,170), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     ...
     & TMP, W, AMP(1,208))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,114), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     ...
     & TMP, W, AMP(1,210))  !  count 1
      CALL FFV2_3_3(W(1,17),W(1,81),GC_50,GC_58,MDL_MZ,ZERO,W(1,219))  !  count 28
      CALL VVS1P1N_3(W(1,219), W(1,22), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,211))  !  count 1
      CALL FFV2_3_3(W(1,17),W(1,76),GC_50,GC_58,MDL_MZ,ZERO,W(1,220))  !  count 28
      CALL VVS1P1N_3(W(1,220), W(1,24), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,212))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,187), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     ...
     & TMP, W, AMP(1,214))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,187), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,215))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,26), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     ...
     & TMP, W, AMP(1,217))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,37),GC_1,ZERO,FK_ZERO,W(1,221))  !  count 16
     ...
     & TMP, W, AMP(1,220))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,76),GC_1,ZERO,FK_ZERO,W(1,222))  !  count 16
     ...
     & TMP, W, AMP(1,225))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,186), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     ...
     & TMP, W, AMP(1,227))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,186), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,232))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,131), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,233))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,40), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,234))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,131), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,235))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,40), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     ...
     & TMP, W, AMP(1,237))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,47),GC_1,ZERO,FK_ZERO,W(1,223))  !  count 16
     ...
     & TMP, W, AMP(1,240))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,81),GC_1,ZERO,FK_ZERO,W(1,224))  !  count 16
     ...
     & TMP, W, AMP(1,245))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,130), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,246))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,78), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,247))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,130), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,248))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,78), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     ...
     & TMP, W, AMP(1,252))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,208), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,253))  !  count 1
      CALL FFV2_5P1N_1(W(1,2), W(1,61), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,254))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,223), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,255))  !  count 1
      CALL FFV2_5P1N_1(W(1,2), W(1,213), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,258))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,208), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,259))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,61), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,260))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,152), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,261))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,62), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,262))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,221), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,263))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,214), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,266))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,152), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,267))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,62), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,268))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,224), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,269))  !  count 1
      CALL FFV2_5P1N_1(W(1,2), W(1,219), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,272))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,206), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,273))  !  count 1
      CALL FFV2_5P1N_1(W(1,2), W(1,95), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,274))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,206), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,275))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,95), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,278))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,222), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,279))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,220), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,282))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,150), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,283))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,96), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,284))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,150), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,285))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,96), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
