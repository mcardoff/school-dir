...
C     
C     Process: u~ c~ > w- w- h d~ s~ QCD=0 QED<=5 @2
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1))  !  count 71
      ...
      CALL IXXXXX(P(0,9),ZERO,+1,-1*IC(9),W(1,17))  !  count 63
      CALL IXXXXX(P(0,10),ZERO,+1,-1*IC(10),W(1,18))  !  count 87
      CALL FFV2_2(W(1,17),W(1,5),GC_100,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV2_2(W(1,18),W(1,8),GC_100,ZERO,FK_ZERO,W(1,20))  !  count 15
      CALL FFV2_5_3(W(1,19),W(1,1),-GC_50,GC_58,MDL_MZ,ZERO,W(1,21))  !  count 28
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1P0_3(W(1,19),W(1,1),GC_2,ZERO,FK_ZERO,W(1,25))  !  count 16
     ...
     & TMP, W, AMP(1,4))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,34), W(1,1), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/30,31,32,33/),
     ...
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV2_1(W(1,1),W(1,8),GC_100,ZERO,FK_ZERO,W(1,35))  !  count 7
     ...
     & TMP, W, AMP(1,13))  !  count 1
      CALL FFV2_2(W(1,17),W(1,8),GC_100,ZERO,FK_ZERO,W(1,47))  !  count 4
      CALL FFV2_2(W(1,18),W(1,5),GC_100,ZERO,FK_ZERO,W(1,48))  !  count 15
      CALL FFV2_5_3(W(1,47),W(1,1),-GC_50,GC_58,MDL_MZ,ZERO,W(1,49))  !  count 28
     ...
     & TMP, W, AMP(1,15))  !  count 1
      CALL FFV1P0_3(W(1,47),W(1,1),GC_2,ZERO,FK_ZERO,W(1,52))  !  count 16
     ...
     & TMP, W, AMP(1,17))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,57), W(1,1), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,20))  !  count 1
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO,FK_ZERO,W(1,58))  !  count 7
     ...
     & TMP, W, AMP(1,26))  !  count 1
      CALL FFV2_3(W(1,17),W(1,1),GC_100,MDL_MW,ZERO,W(1,70))  !  count 55
     ...
     & TMP, W, AMP(1,96))  !  count 1
      CALL FFV2_2(W(1,17),W(1,30),GC_100,ZERO,FK_ZERO,W(1,126))  !  count 7
      CALL FFV2_2(W(1,17),W(1,31),GC_100,ZERO,FK_ZERO,W(1,127))  !  count 7
      CALL FFV2_2(W(1,17),W(1,32),GC_100,ZERO,FK_ZERO,W(1,128))  !  count 7
      CALL FFV2_2(W(1,17),W(1,33),GC_100,ZERO,FK_ZERO,W(1,129))  !  count 7
      CALL FFV1P1N_1(W(1,1), W(1,76), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
     & TMP, W, AMP(1,97))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,50), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
     & TMP, W, AMP(1,98))  !  count 1
      CALL FFV2_1(W(1,1),W(1,30),GC_100,ZERO,FK_ZERO,W(1,130))  !  count 6
      CALL FFV2_1(W(1,1),W(1,31),GC_100,ZERO,FK_ZERO,W(1,131))  !  count 6
      CALL FFV2_1(W(1,1),W(1,32),GC_100,ZERO,FK_ZERO,W(1,132))  !  count 6
      CALL FFV2_1(W(1,1),W(1,33),GC_100,ZERO,FK_ZERO,W(1,133))  !  count 6
      CALL FFV1P1N_2(W(1,17), W(1,76), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/130,131,132,133/),
     & TMP, W, AMP(1,99))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,50), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/130,131,132,133/),
     & TMP, W, AMP(1,100))  !  count 1
      CALL FFV2_3_3(W(1,17),W(1,35),GC_50,GC_58,MDL_MZ,ZERO,W(1,134))  !  count 28
      CALL VVS1P1N_3(W(1,134), W(1,50), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,101))  !  count 1
      CALL FFV2_2(W(1,17),W(1,53),GC_100,ZERO,FK_ZERO,W(1,135))  !  count 7
      CALL FFV2_2(W(1,17),W(1,54),GC_100,ZERO,FK_ZERO,W(1,136))  !  count 7
      CALL FFV2_2(W(1,17),W(1,55),GC_100,ZERO,FK_ZERO,W(1,137))  !  count 7
      CALL FFV2_2(W(1,17),W(1,56),GC_100,ZERO,FK_ZERO,W(1,138))  !  count 7
      CALL FFV1P1N_1(W(1,1), W(1,87), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     & TMP, W, AMP(1,102))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,22), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     & TMP, W, AMP(1,103))  !  count 1
      CALL FFV2_1(W(1,1),W(1,53),GC_100,ZERO,FK_ZERO,W(1,139))  !  count 6
      CALL FFV2_1(W(1,1),W(1,54),GC_100,ZERO,FK_ZERO,W(1,140))  !  count 6
      CALL FFV2_1(W(1,1),W(1,55),GC_100,ZERO,FK_ZERO,W(1,141))  !  count 6
      CALL FFV2_1(W(1,1),W(1,56),GC_100,ZERO,FK_ZERO,W(1,142))  !  count 6
      CALL FFV1P1N_2(W(1,17), W(1,87), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/139,140,141,142/),
     & TMP, W, AMP(1,104))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,22), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/139,140,141,142/),
     & TMP, W, AMP(1,105))  !  count 1
      CALL FFV2_3_3(W(1,17),W(1,58),GC_50,GC_58,MDL_MZ,ZERO,W(1,143))  !  count 28
      CALL VVS1P1N_3(W(1,143), W(1,22), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,106))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,104), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     & TMP, W, AMP(1,107))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,24), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     & TMP, W, AMP(1,108))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,104), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/139,140,141,142/),
     & TMP, W, AMP(1,109))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,24), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/139,140,141,142/),
     ...
     & TMP, W, AMP(1,111))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,35),GC_1,ZERO,FK_ZERO,W(1,144))  !  count 16
     ...
     & TMP, W, AMP(1,114))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,58),GC_1,ZERO,FK_ZERO,W(1,145))  !  count 16
     ...
     & TMP, W, AMP(1,119))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,103), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
     & TMP, W, AMP(1,120))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,51), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
     & TMP, W, AMP(1,121))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,103), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/130,131,132,133/),
     & TMP, W, AMP(1,122))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,51), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/130,131,132,133/),
     ...
     & TMP, W, AMP(1,130))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,125), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     & TMP, W, AMP(1,131))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,46), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     & TMP, W, AMP(1,132))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,125), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/139,140,141,142/),
     & TMP, W, AMP(1,133))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,46), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/139,140,141,142/),
     ...
     & TMP, W, AMP(1,139))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,123), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
     & TMP, W, AMP(1,140))  !  count 1
      CALL FFV2_5P1N_1(W(1,1), W(1,69), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
     & TMP, W, AMP(1,141))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,123), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/130,131,132,133/),
     & TMP, W, AMP(1,142))  !  count 1
      CALL FFV2_3P1N_2(W(1,17), W(1,69), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/130,131,132,133/),
