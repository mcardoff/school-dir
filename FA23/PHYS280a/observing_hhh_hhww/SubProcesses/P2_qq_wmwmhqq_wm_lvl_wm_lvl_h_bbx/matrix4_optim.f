...
C     ----------
     ...
     & TMP, W, AMP(1,8))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,18), W(1,25), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     ...
     & TMP, W, AMP(1,10))  !  count 1
      ...
      CALL FFV1P1N_2(W(1,2), W(1,25), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
     ...
     & TMP, W, AMP(1,12))  !  count 1
      ...
      CALL FFV2_3_3(W(1,2),W(1,45),GC_50,GC_58,MDL_MZ,ZERO,W(1,46))  !  count 24
     ...
     & TMP, W, AMP(1,13))  !  count 1
      ...
      CALL FFV2_5_3(W(1,48),W(1,18),-GC_50,GC_58,MDL_MZ,ZERO,W(1,50))  !  count 24
     ...
     & TMP, W, AMP(1,22))  !  count 1
      CALL FFV2_5P1N_1(W(1,18), W(1,49), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,23))  !  count 1
      ...
      CALL FFV1P1N_2(W(1,2), W(1,52), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     ...
     & TMP, W, AMP(1,25))  !  count 1
      ...
      CALL FFV2_3_3(W(1,2),W(1,68),GC_50,GC_58,MDL_MZ,ZERO,W(1,69))  !  count 24
     ...
     & TMP, W, AMP(1,27))  !  count 1
      ...
      CALL FFV1P0_3(W(1,48),W(1,18),GC_2,ZERO,FK_ZERO,W(1,76))  !  count 12
     ...
     & TMP, W, AMP(1,30))  !  count 1
      ...
      CALL FFV1P1N_3(W(1,48), W(1,18), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/78,79,80,81/),
     & TMP, W, AMP(1,31))  !  count 1
      ...
      CALL FFV2_5P1N_3(W(1,48), W(1,18), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/82,83,84,85/),
     ...
     & TMP, W, AMP(1,34))  !  count 1
      CALL FFV1P0_3(W(1,20),W(1,18),GC_2,ZERO,FK_ZERO,W(1,87))  !  count 12
     ...
     & TMP, W, AMP(1,76))  !  count 1
      CALL FFV1P1N_1(W(1,18), W(1,102), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,77))  !  count 1
      CALL FFV2_5P1N_1(W(1,18), W(1,71), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,78))  !  count 1
      CALL FFV1P1N_2(W(1,2), W(1,102), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     & TMP, W, AMP(1,79))  !  count 1
      CALL FFV2_3P1N_2(W(1,2), W(1,71), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     & TMP, W, AMP(1,80))  !  count 1
      CALL FFV1P1N_3(W(1,2), W(1,45), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/89,90,91,92/),
     & TMP, W, AMP(1,81))  !  count 1
      CALL FFV2_3P1N_3(W(1,2), W(1,45), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/93,94,95,96/),
     ...
     & TMP, W, AMP(1,84))  !  count 1
      CALL FFV1P0_3(W(1,2),W(1,68),GC_1,ZERO,FK_ZERO,W(1,123))  !  count 12
     ...
     & TMP, W, AMP(1,87))  !  count 1
      CALL FFV1P1N_3(W(1,2), W(1,68), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/78,79,80,81/),
     & TMP, W, AMP(1,88))  !  count 1
      CALL FFV2_3P1N_3(W(1,2), W(1,68), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/82,83,84,85/),
     & TMP, W, AMP(1,89))  !  count 1
      CALL FFV1P1N_1(W(1,18), W(1,99), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     & TMP, W, AMP(1,90))  !  count 1
      CALL FFV2_5P1N_1(W(1,18), W(1,86), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     & TMP, W, AMP(1,91))  !  count 1
      CALL FFV1P1N_2(W(1,2), W(1,99), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
     & TMP, W, AMP(1,92))  !  count 1
      CALL FFV2_3P1N_2(W(1,2), W(1,86), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
     ...
     & TMP, W, AMP(1,94))  !  count 1
      CALL FFV1P0_3(W(1,2),W(1,45),GC_1,ZERO,FK_ZERO,W(1,125))  !  count 12
     ...
     & TMP, W, AMP(1,126))  !  count 1
      CALL FFV1P1N_1(W(1,18), W(1,144), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,127))  !  count 1
      CALL FFV2_5P1N_1(W(1,18), W(1,134), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,128))  !  count 1
      CALL FFV1P1N_2(W(1,2), W(1,144), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     & TMP, W, AMP(1,129))  !  count 1
      CALL FFV2_3P1N_2(W(1,2), W(1,134), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     ...
     & TMP, W, AMP(1,134))  !  count 1
      CALL FFV1P1N_1(W(1,18), W(1,145), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     & TMP, W, AMP(1,135))  !  count 1
      CALL FFV2_5P1N_1(W(1,18), W(1,143), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     & TMP, W, AMP(1,136))  !  count 1
      CALL FFV1P1N_2(W(1,2), W(1,145), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
     & TMP, W, AMP(1,137))  !  count 1
      CALL FFV2_3P1N_2(W(1,2), W(1,143), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
