...
C     ----------
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL VVV1_3(W(1,23),W(1,8),GC_53,MDL_MZ,FK_MDL_WZ,W(1,24))  !  count 24
      CALL VVS1P1N_3(W(1,21), W(1,24), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1P0_3(W(1,19),W(1,2),GC_1,ZERO,FK_ZERO,W(1,25))  !  count 16
      CALL VVS1_2(W(1,23),W(1,13),GC_72,MDL_MW,FK_MDL_WW,W(1,26))  !  count 14
      CALL VVS1_2(W(1,23),W(1,14),GC_72,MDL_MW,FK_MDL_WW,W(1,27))  !  count 14
      CALL VVS1_2(W(1,23),W(1,15),GC_72,MDL_MW,FK_MDL_WW,W(1,28))  !  count 14
      CALL VVS1_2(W(1,23),W(1,16),GC_72,MDL_MW,FK_MDL_WW,W(1,29))  !  count 14
     ...
     & TMP, W, AMP(1,8))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,17), W(1,25), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     ...
     & TMP, W, AMP(1,10))  !  count 1
      ...
      CALL FFV1P1N_2(W(1,18), W(1,25), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
     ...
     & TMP, W, AMP(1,12))  !  count 1
      ...
      CALL FFV2_5_3(W(1,18),W(1,45),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,46
     $))  !  count 24
     ...
     & TMP, W, AMP(1,13))  !  count 1
      ...
      CALL FFV2_3_3(W(1,47),W(1,2),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,49))
     $  !  count 28
      CALL FFV2_3_3(W(1,48),W(1,17),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,50)
     $)  !  count 24
     ...
     & TMP, W, AMP(1,14))  !  count 1
      CALL VVV1_3(W(1,23),W(1,5),GC_53,MDL_MZ,FK_MDL_WZ,W(1,51))  !  count 24
      CALL VVS1P1N_3(W(1,49), W(1,51), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,15))  !  count 1
      CALL FFV1P0_3(W(1,47),W(1,2),GC_1,ZERO,FK_ZERO,W(1,52))  !  count 16
     ...
     & TMP, W, AMP(1,21))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,17), W(1,52), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,22))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,49), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,23))  !  count 1
      ...
      CALL FFV1P1N_2(W(1,18), W(1,52), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     & TMP, W, AMP(1,24))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,49), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     & TMP, W, AMP(1,25))  !  count 1
      CALL FFV2_1(W(1,17),W(1,5),GC_100,ZERO,FK_ZERO,W(1,68))  !  count 15
      CALL FFV2_5_3(W(1,18),W(1,68),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,69
     $))  !  count 24
     ...
     & TMP, W, AMP(1,26))  !  count 1
      ...
      CALL VVV1_3(W(1,70),W(1,8),GC_53,MDL_MZ,FK_MDL_WZ,W(1,71))  !  count 28
      CALL VVS1P1N_3(W(1,71), W(1,50), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,27))  !  count 1
      CALL VVS1_2(W(1,70),W(1,13),GC_72,MDL_MW,FK_MDL_WW,W(1,72))  !  count 17
      CALL VVS1_2(W(1,70),W(1,14),GC_72,MDL_MW,FK_MDL_WW,W(1,73))  !  count 17
      CALL VVS1_2(W(1,70),W(1,15),GC_72,MDL_MW,FK_MDL_WW,W(1,74))  !  count 17
      CALL VVS1_2(W(1,70),W(1,16),GC_72,MDL_MW,FK_MDL_WW,W(1,75))  !  count 17
      CALL FFV1P0_3(W(1,48),W(1,17),GC_1,ZERO,FK_ZERO,W(1,76))  !  count 12
     ...
     & TMP, W, AMP(1,30))  !  count 1
      ...
      CALL FFV1P1N_3(W(1,48), W(1,17), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/78,79,80,81/),
     & TMP, W, AMP(1,31))  !  count 1
      CALL VVV1_3(W(1,70),W(1,30),GC_53,MDL_MZ,FK_MDL_WZ,W(1,82))  !  count 3
      CALL VVV1_3(W(1,70),W(1,31),GC_53,MDL_MZ,FK_MDL_WZ,W(1,83))  !  count 3
      CALL VVV1_3(W(1,70),W(1,32),GC_53,MDL_MZ,FK_MDL_WZ,W(1,84))  !  count 3
      CALL VVV1_3(W(1,70),W(1,33),GC_53,MDL_MZ,FK_MDL_WZ,W(1,85))  !  count 3
      CALL FFV2_3P1N_3(W(1,48), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/82,83,84,85/),
     ...
     & TMP, W, AMP(1,33))  !  count 1
      CALL VVV1_3(W(1,70),W(1,5),GC_53,MDL_MZ,FK_MDL_WZ,W(1,86))  !  count 28
      CALL VVS1P1N_3(W(1,86), W(1,22), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,34))  !  count 1
      CALL FFV1P0_3(W(1,20),W(1,17),GC_1,ZERO,FK_ZERO,W(1,87))  !  count 12
     ...
     & TMP, W, AMP(1,38))  !  count 1
      CALL VVV1_3(W(1,70),W(1,53),GC_53,MDL_MZ,FK_MDL_WZ,W(1,93))  !  count 3
      CALL VVV1_3(W(1,70),W(1,54),GC_53,MDL_MZ,FK_MDL_WZ,W(1,94))  !  count 3
      CALL VVV1_3(W(1,70),W(1,55),GC_53,MDL_MZ,FK_MDL_WZ,W(1,95))  !  count 3
      CALL VVV1_3(W(1,70),W(1,56),GC_53,MDL_MZ,FK_MDL_WZ,W(1,96))  !  count 3
     ...
     & TMP, W, AMP(1,40))  !  count 1
      CALL VVS1_3(W(1,70),W(1,5),GC_72,MDL_MH,FK_MDL_WH,W(1,97))  !  count 16
      CALL VVS1_3(W(1,23),W(1,8),GC_72,MDL_MH,FK_MDL_WH,W(1,98))  !  count 8
     ...
     & TMP, W, AMP(1,46))  !  count 1
      CALL VVS1_3(W(1,70),W(1,8),GC_72,MDL_MH,FK_MDL_WH,W(1,100))  !  count 16
      CALL VVS1_3(W(1,23),W(1,5),GC_72,MDL_MH,FK_MDL_WH,W(1,101))  !  count 8
     ...
     & TMP, W, AMP(1,59))  !  count 1
      CALL VVVV2_1(W(1,70),W(1,5),W(1,8),GC_35,MDL_MW,FK_MDL_WW,W(1,105)
     $)  !  count 4
     ...
     & TMP, W, AMP(1,60))  !  count 1
      CALL VVSS1_3(W(1,70),W(1,5),W(1,13),GC_34,MDL_MH,FK_MDL_WH,W(1,106
     $))  !  count 1
      CALL VVSS1_3(W(1,70),W(1,5),W(1,14),GC_34,MDL_MH,FK_MDL_WH,W(1,107
     $))  !  count 1
      CALL VVSS1_3(W(1,70),W(1,5),W(1,15),GC_34,MDL_MH,FK_MDL_WH,W(1,108
     $))  !  count 1
      CALL VVSS1_3(W(1,70),W(1,5),W(1,16),GC_34,MDL_MH,FK_MDL_WH,W(1,109
     $))  !  count 1
     ...
     & TMP, W, AMP(1,61))  !  count 1
      CALL VVSS1_3(W(1,70),W(1,8),W(1,13),GC_34,MDL_MH,FK_MDL_WH,W(1,110
     $))  !  count 1
      CALL VVSS1_3(W(1,70),W(1,8),W(1,14),GC_34,MDL_MH,FK_MDL_WH,W(1,111
     $))  !  count 1
      CALL VVSS1_3(W(1,70),W(1,8),W(1,15),GC_34,MDL_MH,FK_MDL_WH,W(1,112
     $))  !  count 1
      CALL VVSS1_3(W(1,70),W(1,8),W(1,16),GC_34,MDL_MH,FK_MDL_WH,W(1,113
     $))  !  count 1
     ...
     & TMP, W, AMP(1,64))  !  count 1
      CALL VVS1_3(W(1,70),W(1,53),GC_72,MDL_MH,FK_MDL_WH,W(1,114))  !  count 1
      CALL VVS1_3(W(1,70),W(1,54),GC_72,MDL_MH,FK_MDL_WH,W(1,115))  !  count 1
      CALL VVS1_3(W(1,70),W(1,55),GC_72,MDL_MH,FK_MDL_WH,W(1,116))  !  count 1
      CALL VVS1_3(W(1,70),W(1,56),GC_72,MDL_MH,FK_MDL_WH,W(1,117))  !  count 1
      CALL VVS1P1N_3(W(1,23), W(1,8), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/114,115,116,117/), 
     ...
     & TMP, W, AMP(1,74))  !  count 1
      CALL VVS1_3(W(1,70),W(1,30),GC_72,MDL_MH,FK_MDL_WH,W(1,118))  !  count 1
      CALL VVS1_3(W(1,70),W(1,31),GC_72,MDL_MH,FK_MDL_WH,W(1,119))  !  count 1
      CALL VVS1_3(W(1,70),W(1,32),GC_72,MDL_MH,FK_MDL_WH,W(1,120))  !  count 1
      CALL VVS1_3(W(1,70),W(1,33),GC_72,MDL_MH,FK_MDL_WH,W(1,121))  !  count 1
      CALL VVS1P1N_3(W(1,23), W(1,5), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/118,119,120,121/), 
     ...
     & TMP, W, AMP(1,76))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,102), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,77))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,71), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,78))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,102), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     & TMP, W, AMP(1,79))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,71), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     & TMP, W, AMP(1,80))  !  count 1
      CALL FFV1P1N_3(W(1,18), W(1,45), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/89,90,91,92/),
     & TMP, W, AMP(1,81))  !  count 1
      CALL FFV2_5P1N_3(W(1,18), W(1,45), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/93,94,95,96/),
     ...
     & TMP, W, AMP(1,84))  !  count 1
      CALL FFV1P0_3(W(1,18),W(1,68),GC_2,ZERO,FK_ZERO,W(1,123))  !  count 12
     ...
     & TMP, W, AMP(1,87))  !  count 1
      CALL FFV1P1N_3(W(1,18), W(1,68), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/78,79,80,81/),
     & TMP, W, AMP(1,88))  !  count 1
      CALL FFV2_5P1N_3(W(1,18), W(1,68), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/82,83,84,85/),
     & TMP, W, AMP(1,89))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,99), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     & TMP, W, AMP(1,90))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,86), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     & TMP, W, AMP(1,91))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,99), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
     & TMP, W, AMP(1,92))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,86), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
     ...
     & TMP, W, AMP(1,94))  !  count 1
      CALL FFV1P0_3(W(1,18),W(1,45),GC_2,ZERO,FK_ZERO,W(1,125))  !  count 12
     ...
     & TMP, W, AMP(1,96))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,2), W(1,76), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
     & TMP, W, AMP(1,97))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,50), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
     ...
     & TMP, W, AMP(1,100))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,35),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,134
     $))  !  count 28
     ...
     & TMP, W, AMP(1,101))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,2), W(1,87), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     ...
     & TMP, W, AMP(1,105))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,58),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,143
     $))  !  count 28
     ...
     & TMP, W, AMP(1,106))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,104), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     ...
     & TMP, W, AMP(1,120))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,51), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
     ...
     & TMP, W, AMP(1,126))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,144), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,127))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,134), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/60,61,62,63/),
     & TMP, W, AMP(1,128))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,144), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     & TMP, W, AMP(1,129))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,134), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/64,65,66,67/),
     & TMP, W, AMP(1,130))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,125), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     & TMP, W, AMP(1,131))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,46), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/135,136,137,138/),
     ...
     & TMP, W, AMP(1,134))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,145), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     & TMP, W, AMP(1,135))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,143), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     & TMP, W, AMP(1,136))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,145), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
     & TMP, W, AMP(1,137))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,143), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/41,42,43,44/),
     ...
     & TMP, W, AMP(1,139))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,123), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/126,127,128,129/),
