...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1))  !  count 148
      ...
      CALL IXXXXX(P(0,9),ZERO,+1,-1*IC(9),W(1,17))  !  count 116
      CALL IXXXXX(P(0,10),ZERO,+1,-1*IC(10),W(1,18))  !  count 164
      CALL FFV2_2(W(1,17),W(1,5),GC_100,ZERO,FK_ZERO,W(1,19))  !  count 8
      CALL FFV2_2(W(1,18),W(1,8),GC_100,ZERO,FK_ZERO,W(1,20))  !  count 30
      CALL FFV2_3_3(W(1,19),W(1,1),GC_50,GC_58,MDL_MZ,ZERO,W(1,21))  !  count 28
      CALL FFV2_3_3(W(1,20),W(1,2),GC_50,GC_58,MDL_MZ,ZERO,W(1,22))  !  count 24
      CALL VVS1P1N_3(W(1,21), W(1,22), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_3(W(1,19),W(1,2),GC_50,GC_58,MDL_MZ,ZERO,W(1,23))  !  count 28
      CALL FFV2_3_3(W(1,20),W(1,1),GC_50,GC_58,MDL_MZ,ZERO,W(1,24))  !  count 24
      CALL VVS1P1N_3(W(1,23), W(1,24), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3(W(1,18),W(1,1),GC_100,MDL_MW,ZERO,W(1,25))  !  count 140
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV1P0_3(W(1,19),W(1,2),GC_1,ZERO,FK_ZERO,W(1,27))  !  count 16
     ...
     & TMP, W, AMP(1,5))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,36), W(1,2), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV2_1(W(1,2),W(1,8),GC_100,ZERO,FK_ZERO,W(1,37))  !  count 22
     ...
     & TMP, W, AMP(1,9))  !  count 1
      CALL FFV2_3(W(1,18),W(1,2),GC_100,MDL_MW,ZERO,W(1,39))  !  count 140
      CALL VVV1_3(W(1,39),W(1,8),GC_53,MDL_MZ,ZERO,W(1,40))  !  count 24
      CALL VVS1P1N_3(W(1,21), W(1,40), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,10))  !  count 1
      CALL FFV1P0_3(W(1,19),W(1,1),GC_1,ZERO,FK_ZERO,W(1,41))  !  count 16
      CALL VVS1_2(W(1,39),W(1,13),GC_72,MDL_MW,ZERO,W(1,42))  !  count 14
      CALL VVS1_2(W(1,39),W(1,14),GC_72,MDL_MW,ZERO,W(1,43))  !  count 14
      CALL VVS1_2(W(1,39),W(1,15),GC_72,MDL_MW,ZERO,W(1,44))  !  count 14
      CALL VVS1_2(W(1,39),W(1,16),GC_72,MDL_MW,ZERO,W(1,45))  !  count 14
     ...
     & TMP, W, AMP(1,12))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,46), W(1,1), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     ...
     & TMP, W, AMP(1,15))  !  count 1
      CALL FFV2_1(W(1,1),W(1,8),GC_100,ZERO,FK_ZERO,W(1,47))  !  count 22
     ...
     & TMP, W, AMP(1,16))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,2), W(1,41), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,17))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,21), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,18))  !  count 1
      CALL FFV2_1(W(1,2),W(1,32),GC_100,ZERO,FK_ZERO,W(1,53))  !  count 12
      CALL FFV2_1(W(1,2),W(1,33),GC_100,ZERO,FK_ZERO,W(1,54))  !  count 12
      CALL FFV2_1(W(1,2),W(1,34),GC_100,ZERO,FK_ZERO,W(1,55))  !  count 12
      CALL FFV2_1(W(1,2),W(1,35),GC_100,ZERO,FK_ZERO,W(1,56))  !  count 12
     ...
     & TMP, W, AMP(1,20))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,27), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,21))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,23), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,22))  !  count 1
      CALL FFV2_1(W(1,1),W(1,32),GC_100,ZERO,FK_ZERO,W(1,57))  !  count 12
      CALL FFV2_1(W(1,1),W(1,33),GC_100,ZERO,FK_ZERO,W(1,58))  !  count 12
      CALL FFV2_1(W(1,1),W(1,34),GC_100,ZERO,FK_ZERO,W(1,59))  !  count 12
      CALL FFV2_1(W(1,1),W(1,35),GC_100,ZERO,FK_ZERO,W(1,60))  !  count 12
     ...
     & TMP, W, AMP(1,25))  !  count 1
      CALL FFV2_5_3(W(1,18),W(1,37),-GC_50,GC_58,MDL_MZ,ZERO,W(1,62))  !  count 24
      CALL VVS1P1N_3(W(1,21), W(1,62), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,26))  !  count 1
      CALL FFV2_2(W(1,17),W(1,8),GC_100,ZERO,FK_ZERO,W(1,63))  !  count 8
      CALL FFV2_2(W(1,18),W(1,5),GC_100,ZERO,FK_ZERO,W(1,64))  !  count 30
      CALL FFV2_3_3(W(1,63),W(1,1),GC_50,GC_58,MDL_MZ,ZERO,W(1,65))  !  count 28
      CALL FFV2_3_3(W(1,64),W(1,2),GC_50,GC_58,MDL_MZ,ZERO,W(1,66))  !  count 24
      CALL VVS1P1N_3(W(1,65), W(1,66), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,27))  !  count 1
      CALL FFV2_3_3(W(1,63),W(1,2),GC_50,GC_58,MDL_MZ,ZERO,W(1,67))  !  count 28
      CALL FFV2_3_3(W(1,64),W(1,1),GC_50,GC_58,MDL_MZ,ZERO,W(1,68))  !  count 24
     ...
     & TMP, W, AMP(1,29))  !  count 1
      CALL FFV1P0_3(W(1,63),W(1,2),GC_1,ZERO,FK_ZERO,W(1,70))  !  count 16
     ...
     & TMP, W, AMP(1,31))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,75), W(1,2), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     ...
     & TMP, W, AMP(1,34))  !  count 1
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO,FK_ZERO,W(1,76))  !  count 22
     ...
     & TMP, W, AMP(1,35))  !  count 1
      CALL VVV1_3(W(1,39),W(1,5),GC_53,MDL_MZ,ZERO,W(1,78))  !  count 24
      CALL VVS1P1N_3(W(1,65), W(1,78), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,36))  !  count 1
      CALL FFV1P0_3(W(1,63),W(1,1),GC_1,ZERO,FK_ZERO,W(1,79))  !  count 16
     ...
     & TMP, W, AMP(1,38))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,80), W(1,1), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     ...
     & TMP, W, AMP(1,41))  !  count 1
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO,FK_ZERO,W(1,81))  !  count 22
     ...
     & TMP, W, AMP(1,42))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,2), W(1,79), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,43))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,65), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,44))  !  count 1
      CALL FFV2_1(W(1,2),W(1,71),GC_100,ZERO,FK_ZERO,W(1,87))  !  count 12
      CALL FFV2_1(W(1,2),W(1,72),GC_100,ZERO,FK_ZERO,W(1,88))  !  count 12
      CALL FFV2_1(W(1,2),W(1,73),GC_100,ZERO,FK_ZERO,W(1,89))  !  count 12
      CALL FFV2_1(W(1,2),W(1,74),GC_100,ZERO,FK_ZERO,W(1,90))  !  count 12
     ...
     & TMP, W, AMP(1,46))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,70), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,47))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,67), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,48))  !  count 1
      CALL FFV2_1(W(1,1),W(1,71),GC_100,ZERO,FK_ZERO,W(1,91))  !  count 12
      CALL FFV2_1(W(1,1),W(1,72),GC_100,ZERO,FK_ZERO,W(1,92))  !  count 12
      CALL FFV2_1(W(1,1),W(1,73),GC_100,ZERO,FK_ZERO,W(1,93))  !  count 12
      CALL FFV2_1(W(1,1),W(1,74),GC_100,ZERO,FK_ZERO,W(1,94))  !  count 12
     ...
     & TMP, W, AMP(1,51))  !  count 1
      CALL FFV2_5_3(W(1,18),W(1,76),-GC_50,GC_58,MDL_MZ,ZERO,W(1,96))  !  count 24
      CALL VVS1P1N_3(W(1,65), W(1,96), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,52))  !  count 1
      CALL FFV2_3(W(1,17),W(1,1),GC_100,MDL_MW,ZERO,W(1,97))  !  count 55
      CALL VVV1_3(W(1,97),W(1,8),GC_53,MDL_MZ,ZERO,W(1,98))  !  count 28
      CALL VVS1P1N_3(W(1,98), W(1,66), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,53))  !  count 1
      CALL VVS1_2(W(1,97),W(1,13),GC_72,MDL_MW,ZERO,W(1,99))  !  count 17
      CALL VVS1_2(W(1,97),W(1,14),GC_72,MDL_MW,ZERO,W(1,100))  !  count 17
      CALL VVS1_2(W(1,97),W(1,15),GC_72,MDL_MW,ZERO,W(1,101))  !  count 17
      CALL VVS1_2(W(1,97),W(1,16),GC_72,MDL_MW,ZERO,W(1,102))  !  count 17
      CALL FFV1P0_3(W(1,64),W(1,2),GC_1,ZERO,FK_ZERO,W(1,103))  !  count 12
     ...
     & TMP, W, AMP(1,55))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,104), W(1,2), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     ...
     & TMP, W, AMP(1,57))  !  count 1
      CALL VVV1_3(W(1,97),W(1,32),GC_53,MDL_MZ,ZERO,W(1,109))  !  count 3
      CALL VVV1_3(W(1,97),W(1,33),GC_53,MDL_MZ,ZERO,W(1,110))  !  count 3
      CALL VVV1_3(W(1,97),W(1,34),GC_53,MDL_MZ,ZERO,W(1,111))  !  count 3
      CALL VVV1_3(W(1,97),W(1,35),GC_53,MDL_MZ,ZERO,W(1,112))  !  count 3
     ...
     & TMP, W, AMP(1,59))  !  count 1
      CALL VVV1_3(W(1,97),W(1,5),GC_53,MDL_MZ,ZERO,W(1,113))  !  count 28
      CALL VVS1P1N_3(W(1,113), W(1,22), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,60))  !  count 1
      CALL FFV1P0_3(W(1,20),W(1,2),GC_1,ZERO,FK_ZERO,W(1,114))  !  count 12
     ...
     & TMP, W, AMP(1,62))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,115), W(1,2), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     ...
     & TMP, W, AMP(1,64))  !  count 1
      CALL VVV1_3(W(1,97),W(1,71),GC_53,MDL_MZ,ZERO,W(1,120))  !  count 3
      CALL VVV1_3(W(1,97),W(1,72),GC_53,MDL_MZ,ZERO,W(1,121))  !  count 3
      CALL VVV1_3(W(1,97),W(1,73),GC_53,MDL_MZ,ZERO,W(1,122))  !  count 3
      CALL VVV1_3(W(1,97),W(1,74),GC_53,MDL_MZ,ZERO,W(1,123))  !  count 3
     ...
     & TMP, W, AMP(1,66))  !  count 1
      CALL VVS1_3(W(1,97),W(1,5),GC_72,MDL_MH,ZERO,W(1,124))  !  count 16
      CALL VVS1_3(W(1,39),W(1,8),GC_72,MDL_MH,ZERO,W(1,125))  !  count 8
     ...
     & TMP, W, AMP(1,72))  !  count 1
      CALL VVS1_3(W(1,97),W(1,8),GC_72,MDL_MH,ZERO,W(1,127))  !  count 16
      CALL VVS1_3(W(1,39),W(1,5),GC_72,MDL_MH,ZERO,W(1,128))  !  count 8
     ...
     & TMP, W, AMP(1,85))  !  count 1
      CALL VVVV2_1(W(1,97),W(1,5),W(1,8),GC_35,MDL_MW,ZERO,W(1,132))  !  count 4
      CALL VVS1P1N_3(W(1,39), W(1,132), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,86))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,5),W(1,13),GC_34,MDL_MH,ZERO,W(1,133))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,5),W(1,14),GC_34,MDL_MH,ZERO,W(1,134))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,5),W(1,15),GC_34,MDL_MH,ZERO,W(1,135))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,5),W(1,16),GC_34,MDL_MH,ZERO,W(1,136))  !  count 1
      CALL VVS1P1N_3(W(1,39), W(1,8), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/133,134,135,136/), 
     & TMP, W, AMP(1,87))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,8),W(1,13),GC_34,MDL_MH,ZERO,W(1,137))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,8),W(1,14),GC_34,MDL_MH,ZERO,W(1,138))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,8),W(1,15),GC_34,MDL_MH,ZERO,W(1,139))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,8),W(1,16),GC_34,MDL_MH,ZERO,W(1,140))  !  count 1
     ...
     & TMP, W, AMP(1,90))  !  count 1
      CALL VVS1_3(W(1,97),W(1,71),GC_72,MDL_MH,ZERO,W(1,141))  !  count 1
      CALL VVS1_3(W(1,97),W(1,72),GC_72,MDL_MH,ZERO,W(1,142))  !  count 1
      CALL VVS1_3(W(1,97),W(1,73),GC_72,MDL_MH,ZERO,W(1,143))  !  count 1
      CALL VVS1_3(W(1,97),W(1,74),GC_72,MDL_MH,ZERO,W(1,144))  !  count 1
      CALL VVS1P1N_3(W(1,39), W(1,8), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/141,142,143,144/), 
     ...
     & TMP, W, AMP(1,100))  !  count 1
      CALL VVS1_3(W(1,97),W(1,32),GC_72,MDL_MH,ZERO,W(1,145))  !  count 1
      CALL VVS1_3(W(1,97),W(1,33),GC_72,MDL_MH,ZERO,W(1,146))  !  count 1
      CALL VVS1_3(W(1,97),W(1,34),GC_72,MDL_MH,ZERO,W(1,147))  !  count 1
      CALL VVS1_3(W(1,97),W(1,35),GC_72,MDL_MH,ZERO,W(1,148))  !  count 1
      CALL VVS1P1N_3(W(1,39), W(1,5), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/145,146,147,148/), 
     ...
     & TMP, W, AMP(1,102))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,129), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,103))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,98), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,115))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,126), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,116))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,113), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,122))  !  count 1
      CALL FFV2_3(W(1,17),W(1,2),GC_100,MDL_MW,ZERO,W(1,153))  !  count 55
     ...
     & TMP, W, AMP(1,123))  !  count 1
      ...
      CALL FFV1P0_3(W(1,64),W(1,1),GC_1,ZERO,FK_ZERO,W(1,159))  !  count 12
     ...
     & TMP, W, AMP(1,125))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,160), W(1,1), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,126))  !  count 1
      ...
      CALL FFV1P1N_3(W(1,64), W(1,1), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/161,162,163,164/),
     & TMP, W, AMP(1,127))  !  count 1
      ...
      CALL FFV2_3P1N_3(W(1,64), W(1,1), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/165,166,167,168/),
     ...
     & TMP, W, AMP(1,130))  !  count 1
      CALL FFV1P0_3(W(1,20),W(1,1),GC_1,ZERO,FK_ZERO,W(1,170))  !  count 12
     ...
     & TMP, W, AMP(1,132))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,171), W(1,1), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,133))  !  count 1
      ...
      CALL FFV1P1N_3(W(1,20), W(1,1), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/172,173,174,175/),
     & TMP, W, AMP(1,134))  !  count 1
      ...
      CALL FFV2_3P1N_3(W(1,20), W(1,1), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/176,177,178,179/),
     ...
     & TMP, W, AMP(1,172))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,185), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,173))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,154), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,185))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,182), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,186))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,169), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,192))  !  count 1
      CALL FFV2_2(W(1,17),W(1,32),GC_100,ZERO,FK_ZERO,W(1,209))  !  count 14
      CALL FFV2_2(W(1,17),W(1,33),GC_100,ZERO,FK_ZERO,W(1,210))  !  count 14
      CALL FFV2_2(W(1,17),W(1,34),GC_100,ZERO,FK_ZERO,W(1,211))  !  count 14
      CALL FFV2_2(W(1,17),W(1,35),GC_100,ZERO,FK_ZERO,W(1,212))  !  count 14
      CALL FFV1P1N_1(W(1,2), W(1,159), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,193))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,68), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,194))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,103), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,195))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,66), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,196))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,159), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,197))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,68), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,198))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,103), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,199))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,66), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,200))  !  count 1
      CALL FFV2_5_3(W(1,17),W(1,47),-GC_50,GC_58,MDL_MZ,ZERO,W(1,213))  !  count 28
      CALL VVS1P1N_3(W(1,213), W(1,66), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,201))  !  count 1
      CALL FFV2_5_3(W(1,17),W(1,37),-GC_50,GC_58,MDL_MZ,ZERO,W(1,214))  !  count 28
      CALL VVS1P1N_3(W(1,214), W(1,68), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,202))  !  count 1
      CALL FFV2_2(W(1,17),W(1,71),GC_100,ZERO,FK_ZERO,W(1,215))  !  count 14
      CALL FFV2_2(W(1,17),W(1,72),GC_100,ZERO,FK_ZERO,W(1,216))  !  count 14
      CALL FFV2_2(W(1,17),W(1,73),GC_100,ZERO,FK_ZERO,W(1,217))  !  count 14
      CALL FFV2_2(W(1,17),W(1,74),GC_100,ZERO,FK_ZERO,W(1,218))  !  count 14
      CALL FFV1P1N_1(W(1,2), W(1,170), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,203))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,24), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,204))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,114), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,205))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,22), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,206))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,170), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,207))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,24), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,208))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,114), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,209))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,22), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,210))  !  count 1
      CALL FFV2_5_3(W(1,17),W(1,81),-GC_50,GC_58,MDL_MZ,ZERO,W(1,219))  !  count 28
      CALL VVS1P1N_3(W(1,219), W(1,22), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,211))  !  count 1
      CALL FFV2_5_3(W(1,17),W(1,76),-GC_50,GC_58,MDL_MZ,ZERO,W(1,220))  !  count 28
      CALL VVS1P1N_3(W(1,220), W(1,24), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,212))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,187), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     ...
     & TMP, W, AMP(1,214))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,187), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,215))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,26), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     ...
     & TMP, W, AMP(1,217))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,37),GC_2,ZERO,FK_ZERO,W(1,221))  !  count 16
     ...
     & TMP, W, AMP(1,220))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,76),GC_2,ZERO,FK_ZERO,W(1,222))  !  count 16
     ...
     & TMP, W, AMP(1,225))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,186), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,226))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,69), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,227))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,186), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,228))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,69), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,232))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,131), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,233))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,40), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,234))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,131), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,235))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,40), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     ...
     & TMP, W, AMP(1,237))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,47),GC_2,ZERO,FK_ZERO,W(1,223))  !  count 16
     ...
     & TMP, W, AMP(1,240))  !  count 1
      CALL FFV1P0_3(W(1,17),W(1,81),GC_2,ZERO,FK_ZERO,W(1,224))  !  count 16
     ...
     & TMP, W, AMP(1,245))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,130), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,246))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,78), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,247))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,130), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,248))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,78), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     ...
     & TMP, W, AMP(1,252))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,208), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,253))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,61), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,254))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,223), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,255))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,213), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,258))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,208), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,259))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,61), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,260))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,152), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,261))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,62), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,262))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,221), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,263))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,214), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     ...
     & TMP, W, AMP(1,266))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,152), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,267))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,62), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,268))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,224), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,269))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,219), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,272))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,206), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,273))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,95), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,274))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,206), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,275))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,95), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,278))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,222), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,279))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,220), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     ...
     & TMP, W, AMP(1,282))  !  count 1
      CALL FFV1P1N_1(W(1,1), W(1,150), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,283))  !  count 1
      CALL FFV2_3P1N_1(W(1,1), W(1,96), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,284))  !  count 1
      CALL FFV1P1N_2(W(1,17), W(1,150), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,285))  !  count 1
      CALL FFV2_5P1N_2(W(1,17), W(1,96), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
