...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,10),ZERO,+1,-1*IC(10),W(1,18))  !  count 164
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO,FK_ZERO,W(1,19))  !  count 8
      CALL FFV2_2(W(1,18),W(1,8),GC_100,ZERO,FK_ZERO,W(1,20))  !  count 30
      CALL FFV2_3_3(W(1,19),W(1,2),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,21))
     $  !  count 28
      CALL FFV2_3_3(W(1,20),W(1,17),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,22)
     $)  !  count 24
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_3(W(1,19),W(1,17),GC_50,GC_58,MDL_MZ,ZERO,W(1,23))  !  count 28
      CALL FFV2_3_3(W(1,20),W(1,2),GC_50,GC_58,MDL_MZ,ZERO,W(1,24))  !  count 24
      CALL VVS1P1N_3(W(1,23), W(1,24), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3(W(1,18),W(1,2),GC_100,MDL_MW,ZERO,W(1,25))  !  count 140
      CALL VVV1_3(W(1,25),W(1,8),GC_53,MDL_MZ,ZERO,W(1,26))  !  count 24
      CALL VVS1P1N_3(W(1,23), W(1,26), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV1P0_3(W(1,19),W(1,17),GC_1,ZERO,FK_ZERO,W(1,27))  !  count 16
      CALL VVS1_2(W(1,25),W(1,13),GC_72,MDL_MW,ZERO,W(1,28))  !  count 14
      CALL VVS1_2(W(1,25),W(1,14),GC_72,MDL_MW,ZERO,W(1,29))  !  count 14
      CALL VVS1_2(W(1,25),W(1,15),GC_72,MDL_MW,ZERO,W(1,30))  !  count 14
      CALL VVS1_2(W(1,25),W(1,16),GC_72,MDL_MW,ZERO,W(1,31))  !  count 14
      CALL VVV1P1N_2(W(1,27), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,23), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,5))  !  count 1
      CALL VVS1_1(W(1,8),W(1,13),GC_72,MDL_MW,FK_MDL_WW,W(1,32))  !  count 32
      CALL VVS1_1(W(1,8),W(1,14),GC_72,MDL_MW,FK_MDL_WW,W(1,33))  !  count 32
      CALL VVS1_1(W(1,8),W(1,15),GC_72,MDL_MW,FK_MDL_WW,W(1,34))  !  count 32
      CALL VVS1_1(W(1,8),W(1,16),GC_72,MDL_MW,FK_MDL_WW,W(1,35))  !  count 32
      CALL FFV2_2(W(1,19),W(1,25),GC_100,ZERO,FK_ZERO,W(1,36))  !  count 4
      CALL FFV2P1N_3(W(1,36), W(1,17), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL VVV1P1N_3(W(1,27), W(1,25), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,7))  !  count 1
      CALL VVV1P1N_2(W(1,25), W(1,23), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV2_1(W(1,17),W(1,8),GC_100,ZERO,FK_ZERO,W(1,37))  !  count 22
      CALL FFV2_3(W(1,19),W(1,37),GC_100,MDL_MW,ZERO,W(1,38))  !  count 4
      CALL VVS1P1N_3(W(1,25), W(1,38), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,9))  !  count 1
      CALL FFV2_3(W(1,18),W(1,17),GC_100,MDL_MW,FK_MDL_WW,W(1,39))  !  count 140
      CALL VVV1_3(W(1,39),W(1,8),GC_53,MDL_MZ,FK_MDL_WZ,W(1,40))  !  count 24
      CALL VVS1P1N_3(W(1,21), W(1,40), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,10))  !  count 1
      CALL FFV1P0_3(W(1,19),W(1,2),GC_1,ZERO,FK_ZERO,W(1,41))  !  count 16
      CALL VVS1_2(W(1,39),W(1,13),GC_72,MDL_MW,FK_MDL_WW,W(1,42))  !  count 14
      CALL VVS1_2(W(1,39),W(1,14),GC_72,MDL_MW,FK_MDL_WW,W(1,43))  !  count 14
      CALL VVS1_2(W(1,39),W(1,15),GC_72,MDL_MW,FK_MDL_WW,W(1,44))  !  count 14
      CALL VVS1_2(W(1,39),W(1,16),GC_72,MDL_MW,FK_MDL_WW,W(1,45))  !  count 14
      CALL VVV1P1N_2(W(1,41), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     ...
     & TMP, W, AMP(1,12))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,46), W(1,2), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,13))  !  count 1
      CALL VVV1P1N_3(W(1,41), W(1,39), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,14))  !  count 1
      CALL VVV1P1N_2(W(1,39), W(1,21), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,15))  !  count 1
      CALL FFV2_1(W(1,2),W(1,8),GC_100,ZERO,FK_ZERO,W(1,47))  !  count 22
      CALL FFV2_3(W(1,19),W(1,47),GC_100,MDL_MW,FK_MDL_WW,W(1,48))  !  count 4
      CALL VVS1P1N_3(W(1,39), W(1,48), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,16))  !  count 1
      CALL FFV2_2(W(1,18),W(1,32),GC_100,ZERO,FK_ZERO,W(1,49))  !  count 12
      CALL FFV2_2(W(1,18),W(1,33),GC_100,ZERO,FK_ZERO,W(1,50))  !  count 12
      CALL FFV2_2(W(1,18),W(1,34),GC_100,ZERO,FK_ZERO,W(1,51))  !  count 12
      CALL FFV2_2(W(1,18),W(1,35),GC_100,ZERO,FK_ZERO,W(1,52))  !  count 12
      CALL FFV1P1N_1(W(1,17), W(1,41), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,17))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,21), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,18))  !  count 1
      CALL FFV2_1(W(1,17),W(1,32),GC_100,ZERO,FK_ZERO,W(1,53))  !  count 12
      CALL FFV2_1(W(1,17),W(1,33),GC_100,ZERO,FK_ZERO,W(1,54))  !  count 12
      CALL FFV2_1(W(1,17),W(1,34),GC_100,ZERO,FK_ZERO,W(1,55))  !  count 12
      CALL FFV2_1(W(1,17),W(1,35),GC_100,ZERO,FK_ZERO,W(1,56))  !  count 12
      CALL FFV1P1N_2(W(1,18), W(1,41), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,19))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,21), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,20))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,27), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,21))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,23), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,22))  !  count 1
      CALL FFV2_1(W(1,2),W(1,32),GC_100,ZERO,FK_ZERO,W(1,57))  !  count 12
      CALL FFV2_1(W(1,2),W(1,33),GC_100,ZERO,FK_ZERO,W(1,58))  !  count 12
      CALL FFV2_1(W(1,2),W(1,34),GC_100,ZERO,FK_ZERO,W(1,59))  !  count 12
      CALL FFV2_1(W(1,2),W(1,35),GC_100,ZERO,FK_ZERO,W(1,60))  !  count 12
      CALL FFV1P1N_2(W(1,18), W(1,27), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,23))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,23), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,24))  !  count 1
      CALL FFV2_5_3(W(1,18),W(1,47),-GC_50,GC_58,MDL_MZ,ZERO,W(1,61))  !  count 24
      CALL VVS1P1N_3(W(1,23), W(1,61), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,25))  !  count 1
      CALL FFV2_5_3(W(1,18),W(1,37),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,62
     $))  !  count 24
     ...
     & TMP, W, AMP(1,26))  !  count 1
      ...
      CALL FFV2_2(W(1,18),W(1,5),GC_100,ZERO,FK_ZERO,W(1,64))  !  count 30
      CALL FFV2_3_3(W(1,63),W(1,2),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,65))
     $  !  count 28
      CALL FFV2_3_3(W(1,64),W(1,17),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,66)
     $)  !  count 24
     ...
     & TMP, W, AMP(1,27))  !  count 1
      CALL FFV2_3_3(W(1,63),W(1,17),GC_50,GC_58,MDL_MZ,ZERO,W(1,67))  !  count 28
      CALL FFV2_3_3(W(1,64),W(1,2),GC_50,GC_58,MDL_MZ,ZERO,W(1,68))  !  count 24
      CALL VVS1P1N_3(W(1,67), W(1,68), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,28))  !  count 1
      CALL VVV1_3(W(1,25),W(1,5),GC_53,MDL_MZ,ZERO,W(1,69))  !  count 24
      CALL VVS1P1N_3(W(1,67), W(1,69), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,29))  !  count 1
      CALL FFV1P0_3(W(1,63),W(1,17),GC_1,ZERO,FK_ZERO,W(1,70))  !  count 16
      CALL VVV1P1N_2(W(1,70), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,30))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,67), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,31))  !  count 1
      CALL VVS1_1(W(1,5),W(1,13),GC_72,MDL_MW,FK_MDL_WW,W(1,71))  !  count 32
      CALL VVS1_1(W(1,5),W(1,14),GC_72,MDL_MW,FK_MDL_WW,W(1,72))  !  count 32
      CALL VVS1_1(W(1,5),W(1,15),GC_72,MDL_MW,FK_MDL_WW,W(1,73))  !  count 32
      CALL VVS1_1(W(1,5),W(1,16),GC_72,MDL_MW,FK_MDL_WW,W(1,74))  !  count 32
      CALL FFV2_2(W(1,63),W(1,25),GC_100,ZERO,FK_ZERO,W(1,75))  !  count 4
      CALL FFV2P1N_3(W(1,75), W(1,17), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,32))  !  count 1
      CALL VVV1P1N_3(W(1,70), W(1,25), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,33))  !  count 1
      CALL VVV1P1N_2(W(1,25), W(1,67), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,34))  !  count 1
      CALL FFV2_1(W(1,17),W(1,5),GC_100,ZERO,FK_ZERO,W(1,76))  !  count 22
      CALL FFV2_3(W(1,63),W(1,76),GC_100,MDL_MW,ZERO,W(1,77))  !  count 4
      CALL VVS1P1N_3(W(1,25), W(1,77), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,35))  !  count 1
      CALL VVV1_3(W(1,39),W(1,5),GC_53,MDL_MZ,FK_MDL_WZ,W(1,78))  !  count 24
      CALL VVS1P1N_3(W(1,65), W(1,78), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,36))  !  count 1
      CALL FFV1P0_3(W(1,63),W(1,2),GC_1,ZERO,FK_ZERO,W(1,79))  !  count 16
      CALL VVV1P1N_2(W(1,79), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,37))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,65), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,38))  !  count 1
      CALL FFV2_2(W(1,63),W(1,39),GC_100,ZERO,FK_ZERO,W(1,80))  !  count 4
      CALL FFV2P1N_3(W(1,80), W(1,2), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,39))  !  count 1
      CALL VVV1P1N_3(W(1,79), W(1,39), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,40))  !  count 1
      CALL VVV1P1N_2(W(1,39), W(1,65), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,41))  !  count 1
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO,FK_ZERO,W(1,81))  !  count 22
      CALL FFV2_3(W(1,63),W(1,81),GC_100,MDL_MW,FK_MDL_WW,W(1,82))  !  count 4
      CALL VVS1P1N_3(W(1,39), W(1,82), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,42))  !  count 1
      CALL FFV2_2(W(1,18),W(1,71),GC_100,ZERO,FK_ZERO,W(1,83))  !  count 12
      CALL FFV2_2(W(1,18),W(1,72),GC_100,ZERO,FK_ZERO,W(1,84))  !  count 12
      CALL FFV2_2(W(1,18),W(1,73),GC_100,ZERO,FK_ZERO,W(1,85))  !  count 12
      CALL FFV2_2(W(1,18),W(1,74),GC_100,ZERO,FK_ZERO,W(1,86))  !  count 12
      CALL FFV1P1N_1(W(1,17), W(1,79), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,43))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,65), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,44))  !  count 1
      CALL FFV2_1(W(1,17),W(1,71),GC_100,ZERO,FK_ZERO,W(1,87))  !  count 12
      CALL FFV2_1(W(1,17),W(1,72),GC_100,ZERO,FK_ZERO,W(1,88))  !  count 12
      CALL FFV2_1(W(1,17),W(1,73),GC_100,ZERO,FK_ZERO,W(1,89))  !  count 12
      CALL FFV2_1(W(1,17),W(1,74),GC_100,ZERO,FK_ZERO,W(1,90))  !  count 12
      CALL FFV1P1N_2(W(1,18), W(1,79), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,45))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,65), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,46))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,70), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,47))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,67), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,48))  !  count 1
      CALL FFV2_1(W(1,2),W(1,71),GC_100,ZERO,FK_ZERO,W(1,91))  !  count 12
      CALL FFV2_1(W(1,2),W(1,72),GC_100,ZERO,FK_ZERO,W(1,92))  !  count 12
      CALL FFV2_1(W(1,2),W(1,73),GC_100,ZERO,FK_ZERO,W(1,93))  !  count 12
      CALL FFV2_1(W(1,2),W(1,74),GC_100,ZERO,FK_ZERO,W(1,94))  !  count 12
      CALL FFV1P1N_2(W(1,18), W(1,70), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,49))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,67), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,50))  !  count 1
      CALL FFV2_5_3(W(1,18),W(1,81),-GC_50,GC_58,MDL_MZ,ZERO,W(1,95))  !  count 24
      CALL VVS1P1N_3(W(1,67), W(1,95), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,51))  !  count 1
      CALL FFV2_5_3(W(1,18),W(1,76),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,96
     $))  !  count 24
     ...
     & TMP, W, AMP(1,52))  !  count 1
      CALL FFV2_3(W(1,1),W(1,2),GC_100,MDL_MW,FK_MDL_WW,W(1,97))  !  count 55
      CALL VVV1_3(W(1,97),W(1,8),GC_53,MDL_MZ,FK_MDL_WZ,W(1,98))  !  count 28
      CALL VVS1P1N_3(W(1,98), W(1,66), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,53))  !  count 1
      CALL VVS1_2(W(1,97),W(1,13),GC_72,MDL_MW,FK_MDL_WW,W(1,99))  !  count 17
      CALL VVS1_2(W(1,97),W(1,14),GC_72,MDL_MW,FK_MDL_WW,W(1,100))  !  count 17
      CALL VVS1_2(W(1,97),W(1,15),GC_72,MDL_MW,FK_MDL_WW,W(1,101))  !  count 17
      CALL VVS1_2(W(1,97),W(1,16),GC_72,MDL_MW,FK_MDL_WW,W(1,102))  !  count 17
      CALL FFV1P0_3(W(1,64),W(1,17),GC_1,ZERO,FK_ZERO,W(1,103))  !  count 12
      CALL VVV1P1N_2(W(1,103), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,54))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,66), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,55))  !  count 1
      CALL FFV2_2(W(1,64),W(1,97),GC_100,ZERO,FK_ZERO,W(1,104))  !  count 4
      CALL FFV2P1N_3(W(1,104), W(1,17), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,56))  !  count 1
      CALL VVV1P0_1(W(1,97),W(1,32),-GC_3,ZERO,FK_ZERO,W(1,105))  !  count 3
      CALL VVV1P0_1(W(1,97),W(1,33),-GC_3,ZERO,FK_ZERO,W(1,106))  !  count 3
      CALL VVV1P0_1(W(1,97),W(1,34),-GC_3,ZERO,FK_ZERO,W(1,107))  !  count 3
      CALL VVV1P0_1(W(1,97),W(1,35),-GC_3,ZERO,FK_ZERO,W(1,108))  !  count 3
      CALL FFV1P1N_3(W(1,64), W(1,17), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/105,106,107,108/),
     & TMP, W, AMP(1,57))  !  count 1
      CALL VVV1_3(W(1,97),W(1,32),GC_53,MDL_MZ,FK_MDL_WZ,W(1,109))  !  count 3
      CALL VVV1_3(W(1,97),W(1,33),GC_53,MDL_MZ,FK_MDL_WZ,W(1,110))  !  count 3
      CALL VVV1_3(W(1,97),W(1,34),GC_53,MDL_MZ,FK_MDL_WZ,W(1,111))  !  count 3
      CALL VVV1_3(W(1,97),W(1,35),GC_53,MDL_MZ,FK_MDL_WZ,W(1,112))  !  count 3
      CALL FFV2_3P1N_3(W(1,64), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/109,110,111,112/),
     ...
     & TMP, W, AMP(1,59))  !  count 1
      CALL VVV1_3(W(1,97),W(1,5),GC_53,MDL_MZ,FK_MDL_WZ,W(1,113))  !  count 28
      CALL VVS1P1N_3(W(1,113), W(1,22), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,60))  !  count 1
      CALL FFV1P0_3(W(1,20),W(1,17),GC_1,ZERO,FK_ZERO,W(1,114))  !  count 12
      CALL VVV1P1N_2(W(1,114), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     ...
     & TMP, W, AMP(1,62))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,115), W(1,17), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,63))  !  count 1
      CALL VVV1P0_1(W(1,97),W(1,71),-GC_3,ZERO,FK_ZERO,W(1,116))  !  count 3
      CALL VVV1P0_1(W(1,97),W(1,72),-GC_3,ZERO,FK_ZERO,W(1,117))  !  count 3
      CALL VVV1P0_1(W(1,97),W(1,73),-GC_3,ZERO,FK_ZERO,W(1,118))  !  count 3
      CALL VVV1P0_1(W(1,97),W(1,74),-GC_3,ZERO,FK_ZERO,W(1,119))  !  count 3
      CALL FFV1P1N_3(W(1,20), W(1,17), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/116,117,118,119/),
     & TMP, W, AMP(1,64))  !  count 1
      CALL VVV1_3(W(1,97),W(1,71),GC_53,MDL_MZ,FK_MDL_WZ,W(1,120))  !  count 3
      CALL VVV1_3(W(1,97),W(1,72),GC_53,MDL_MZ,FK_MDL_WZ,W(1,121))  !  count 3
      CALL VVV1_3(W(1,97),W(1,73),GC_53,MDL_MZ,FK_MDL_WZ,W(1,122))  !  count 3
      CALL VVV1_3(W(1,97),W(1,74),GC_53,MDL_MZ,FK_MDL_WZ,W(1,123))  !  count 3
      CALL FFV2_3P1N_3(W(1,20), W(1,17), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/120,121,122,123/),
     ...
     & TMP, W, AMP(1,66))  !  count 1
      CALL VVS1_3(W(1,97),W(1,5),GC_72,MDL_MH,FK_MDL_WH,W(1,124))  !  count 16
      CALL VVS1_3(W(1,39),W(1,8),GC_72,MDL_MH,FK_MDL_WH,W(1,125))  !  count 8
     ...
     & TMP, W, AMP(1,68))  !  count 1
      CALL VVV1P0_1(W(1,97),W(1,5),-GC_3,ZERO,FK_ZERO,W(1,126))  !  count 16
      CALL VVV1P1N_2(W(1,126), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,69))  !  count 1
      CALL VVS1P1N_1(W(1,8), W(1,124), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,70))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,113), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,71))  !  count 1
      CALL VVSS1P1N_3(W(1,39), W(1,8), W(1,124), GC_34, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,72))  !  count 1
      CALL VVS1_3(W(1,97),W(1,8),GC_72,MDL_MH,FK_MDL_WH,W(1,127))  !  count 16
      CALL VVS1_3(W(1,39),W(1,5),GC_72,MDL_MH,FK_MDL_WH,W(1,128))  !  count 8
     ...
     & TMP, W, AMP(1,74))  !  count 1
      CALL VVV1P0_1(W(1,97),W(1,8),-GC_3,ZERO,FK_ZERO,W(1,129))  !  count 16
      CALL VVV1P1N_2(W(1,129), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,75))  !  count 1
      CALL VVS1P1N_1(W(1,5), W(1,127), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,76))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,98), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,77))  !  count 1
      CALL VVSS1P1N_3(W(1,39), W(1,5), W(1,127), GC_34, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,78))  !  count 1
      CALL VVV1P0_1(W(1,39),W(1,5),-GC_3,ZERO,FK_ZERO,W(1,130))  !  count 12
      CALL VVV1P1N_2(W(1,130), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,79))  !  count 1
      CALL VVS1P1N_1(W(1,8), W(1,128), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,80))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,78), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,81))  !  count 1
      CALL VVV1P0_1(W(1,39),W(1,8),-GC_3,ZERO,FK_ZERO,W(1,131))  !  count 12
      CALL VVV1P1N_2(W(1,131), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,82))  !  count 1
      CALL VVS1P1N_1(W(1,5), W(1,125), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,83))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,40), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,84))  !  count 1
      CALL VVVV2P1N_2(W(1,39), W(1,5), W(1,8), GC_35, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,85))  !  count 1
      CALL VVVV2_1(W(1,97),W(1,5),W(1,8),GC_35,MDL_MW,FK_MDL_WW,W(1,132)
     $)  !  count 4
      CALL VVS1P1N_3(W(1,39), W(1,132), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,86))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,5),W(1,13),GC_34,MDL_MH,FK_MDL_WH,W(1,133
     $))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,5),W(1,14),GC_34,MDL_MH,FK_MDL_WH,W(1,134
     $))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,5),W(1,15),GC_34,MDL_MH,FK_MDL_WH,W(1,135
     $))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,5),W(1,16),GC_34,MDL_MH,FK_MDL_WH,W(1,136
     $))  !  count 1
      CALL VVS1P1N_3(W(1,39), W(1,8), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/133,134,135,136/), 
     & TMP, W, AMP(1,87))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,8),W(1,13),GC_34,MDL_MH,FK_MDL_WH,W(1,137
     $))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,8),W(1,14),GC_34,MDL_MH,FK_MDL_WH,W(1,138
     $))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,8),W(1,15),GC_34,MDL_MH,FK_MDL_WH,W(1,139
     $))  !  count 1
      CALL VVSS1_3(W(1,97),W(1,8),W(1,16),GC_34,MDL_MH,FK_MDL_WH,W(1,140
     $))  !  count 1
      CALL VVS1P1N_3(W(1,39), W(1,5), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/137,138,139,140/), 
     & TMP, W, AMP(1,88))  !  count 1
      CALL VVVV2P1N_3(W(1,97), W(1,39), W(1,8), GC_35, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,89))  !  count 1
      CALL VVV1P1N_1(W(1,39), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/116,117,118,119/),
     & TMP, W, AMP(1,90))  !  count 1
      CALL VVS1_3(W(1,97),W(1,71),GC_72,MDL_MH,FK_MDL_WH,W(1,141))  !  count 1
      CALL VVS1_3(W(1,97),W(1,72),GC_72,MDL_MH,FK_MDL_WH,W(1,142))  !  count 1
      CALL VVS1_3(W(1,97),W(1,73),GC_72,MDL_MH,FK_MDL_WH,W(1,143))  !  count 1
      CALL VVS1_3(W(1,97),W(1,74),GC_72,MDL_MH,FK_MDL_WH,W(1,144))  !  count 1
      CALL VVS1P1N_3(W(1,39), W(1,8), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/141,142,143,144/), 
     & TMP, W, AMP(1,91))  !  count 1
      CALL VVV1P1N_3(W(1,39), W(1,8), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/120,121,122,123/),
     & TMP, W, AMP(1,92))  !  count 1
      CALL VVV1P1N_3(W(1,129), W(1,39), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,93))  !  count 1
      CALL VVS1P1N_2(W(1,39), W(1,127), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,94))  !  count 1
      CALL VVV1P1N_2(W(1,39), W(1,98), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,95))  !  count 1
      CALL VVVV2P1N_4(W(1,97), W(1,39), W(1,5), GC_35, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,96))  !  count 1
      CALL VVV1P1N_3(W(1,126), W(1,39), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,97))  !  count 1
      CALL VVS1P1N_2(W(1,39), W(1,124), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,98))  !  count 1
      CALL VVV1P1N_2(W(1,39), W(1,113), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,99))  !  count 1
      CALL VVV1P1N_1(W(1,39), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/105,106,107,108/),
     & TMP, W, AMP(1,100))  !  count 1
      CALL VVS1_3(W(1,97),W(1,32),GC_72,MDL_MH,FK_MDL_WH,W(1,145))  !  count 1
      CALL VVS1_3(W(1,97),W(1,33),GC_72,MDL_MH,FK_MDL_WH,W(1,146))  !  count 1
      CALL VVS1_3(W(1,97),W(1,34),GC_72,MDL_MH,FK_MDL_WH,W(1,147))  !  count 1
      CALL VVS1_3(W(1,97),W(1,35),GC_72,MDL_MH,FK_MDL_WH,W(1,148))  !  count 1
      CALL VVS1P1N_3(W(1,39), W(1,5), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/145,146,147,148/), 
     & TMP, W, AMP(1,101))  !  count 1
      CALL VVV1P1N_3(W(1,39), W(1,5), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/109,110,111,112/),
     & TMP, W, AMP(1,102))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,129), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,103))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,98), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,104))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,129), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,105))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,98), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,106))  !  count 1
      CALL FFV1P1N_3(W(1,18), W(1,37), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/116,117,118,119/),
     & TMP, W, AMP(1,107))  !  count 1
      CALL FFV2_5P1N_3(W(1,18), W(1,37), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/120,121,122,123/),
     & TMP, W, AMP(1,108))  !  count 1
      CALL FFV2_1(W(1,37),W(1,97),GC_100,ZERO,FK_ZERO,W(1,149))  !  count 4
      CALL FFV2P1N_3(W(1,18), W(1,149), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     ...
     & TMP, W, AMP(1,110))  !  count 1
      CALL FFV1P0_3(W(1,18),W(1,76),GC_2,ZERO,FK_ZERO,W(1,150))  !  count 12
      CALL VVV1P1N_2(W(1,150), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,111))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,96), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,112))  !  count 1
      CALL FFV2_1(W(1,76),W(1,97),GC_100,ZERO,FK_ZERO,W(1,151))  !  count 4
      CALL FFV2P1N_3(W(1,18), W(1,151), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,113))  !  count 1
      CALL FFV1P1N_3(W(1,18), W(1,76), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/105,106,107,108/),
     & TMP, W, AMP(1,114))  !  count 1
      CALL FFV2_5P1N_3(W(1,18), W(1,76), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/109,110,111,112/),
     & TMP, W, AMP(1,115))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,126), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,116))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,113), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,117))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,126), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,118))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,113), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,120))  !  count 1
      CALL FFV1P0_3(W(1,18),W(1,37),GC_2,ZERO,FK_ZERO,W(1,152))  !  count 12
      CALL VVV1P1N_2(W(1,152), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,121))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,62), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/99,100,101,102/),
     & TMP, W, AMP(1,122))  !  count 1
      CALL FFV2_3(W(1,1),W(1,17),GC_100,MDL_MW,ZERO,W(1,153))  !  count 55
      CALL VVV1_3(W(1,153),W(1,8),GC_53,MDL_MZ,ZERO,W(1,154))  !  count 28
      CALL VVS1P1N_3(W(1,154), W(1,68), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,123))  !  count 1
      CALL VVS1_2(W(1,153),W(1,13),GC_72,MDL_MW,ZERO,W(1,155))  !  count 17
      CALL VVS1_2(W(1,153),W(1,14),GC_72,MDL_MW,ZERO,W(1,156))  !  count 17
      CALL VVS1_2(W(1,153),W(1,15),GC_72,MDL_MW,ZERO,W(1,157))  !  count 17
      CALL VVS1_2(W(1,153),W(1,16),GC_72,MDL_MW,ZERO,W(1,158))  !  count 17
      CALL FFV1P0_3(W(1,64),W(1,2),GC_1,ZERO,FK_ZERO,W(1,159))  !  count 12
      CALL VVV1P1N_2(W(1,159), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,124))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,68), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,125))  !  count 1
      CALL FFV2_2(W(1,64),W(1,153),GC_100,ZERO,FK_ZERO,W(1,160))  !  count 4
      CALL FFV2P1N_3(W(1,160), W(1,2), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,126))  !  count 1
      CALL VVV1P0_1(W(1,153),W(1,32),-GC_3,ZERO,FK_ZERO,W(1,161))  !  count 3
      CALL VVV1P0_1(W(1,153),W(1,33),-GC_3,ZERO,FK_ZERO,W(1,162))  !  count 3
      CALL VVV1P0_1(W(1,153),W(1,34),-GC_3,ZERO,FK_ZERO,W(1,163))  !  count 3
      CALL VVV1P0_1(W(1,153),W(1,35),-GC_3,ZERO,FK_ZERO,W(1,164))  !  count 3
      CALL FFV1P1N_3(W(1,64), W(1,2), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/161,162,163,164/),
     & TMP, W, AMP(1,127))  !  count 1
      CALL VVV1_3(W(1,153),W(1,32),GC_53,MDL_MZ,ZERO,W(1,165))  !  count 3
      CALL VVV1_3(W(1,153),W(1,33),GC_53,MDL_MZ,ZERO,W(1,166))  !  count 3
      CALL VVV1_3(W(1,153),W(1,34),GC_53,MDL_MZ,ZERO,W(1,167))  !  count 3
      CALL VVV1_3(W(1,153),W(1,35),GC_53,MDL_MZ,ZERO,W(1,168))  !  count 3
      CALL FFV2_3P1N_3(W(1,64), W(1,2), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/165,166,167,168/),
     ...
     & TMP, W, AMP(1,129))  !  count 1
      CALL VVV1_3(W(1,153),W(1,5),GC_53,MDL_MZ,ZERO,W(1,169))  !  count 28
      CALL VVS1P1N_3(W(1,169), W(1,24), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,130))  !  count 1
      CALL FFV1P0_3(W(1,20),W(1,2),GC_1,ZERO,FK_ZERO,W(1,170))  !  count 12
      CALL VVV1P1N_2(W(1,170), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     ...
     & TMP, W, AMP(1,132))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,171), W(1,2), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,133))  !  count 1
      CALL VVV1P0_1(W(1,153),W(1,71),-GC_3,ZERO,FK_ZERO,W(1,172))  !  count 3
      CALL VVV1P0_1(W(1,153),W(1,72),-GC_3,ZERO,FK_ZERO,W(1,173))  !  count 3
      CALL VVV1P0_1(W(1,153),W(1,73),-GC_3,ZERO,FK_ZERO,W(1,174))  !  count 3
      CALL VVV1P0_1(W(1,153),W(1,74),-GC_3,ZERO,FK_ZERO,W(1,175))  !  count 3
      CALL FFV1P1N_3(W(1,20), W(1,2), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/172,173,174,175/),
     & TMP, W, AMP(1,134))  !  count 1
      CALL VVV1_3(W(1,153),W(1,71),GC_53,MDL_MZ,ZERO,W(1,176))  !  count 3
      CALL VVV1_3(W(1,153),W(1,72),GC_53,MDL_MZ,ZERO,W(1,177))  !  count 3
      CALL VVV1_3(W(1,153),W(1,73),GC_53,MDL_MZ,ZERO,W(1,178))  !  count 3
      CALL VVV1_3(W(1,153),W(1,74),GC_53,MDL_MZ,ZERO,W(1,179))  !  count 3
      CALL FFV2_3P1N_3(W(1,20), W(1,2), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/176,177,178,179/),
     ...
     & TMP, W, AMP(1,136))  !  count 1
      CALL VVS1_3(W(1,153),W(1,5),GC_72,MDL_MH,ZERO,W(1,180))  !  count 16
      CALL VVS1_3(W(1,25),W(1,8),GC_72,MDL_MH,ZERO,W(1,181))  !  count 8
     ...
     & TMP, W, AMP(1,138))  !  count 1
      CALL VVV1P0_1(W(1,153),W(1,5),-GC_3,ZERO,FK_ZERO,W(1,182))  !  count 16
      CALL VVV1P1N_2(W(1,182), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,139))  !  count 1
      CALL VVS1P1N_1(W(1,8), W(1,180), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,140))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,169), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,141))  !  count 1
      CALL VVSS1P1N_3(W(1,25), W(1,8), W(1,180), GC_34, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,142))  !  count 1
      CALL VVS1_3(W(1,153),W(1,8),GC_72,MDL_MH,ZERO,W(1,183))  !  count 16
      CALL VVS1_3(W(1,25),W(1,5),GC_72,MDL_MH,ZERO,W(1,184))  !  count 8
     ...
     & TMP, W, AMP(1,144))  !  count 1
      CALL VVV1P0_1(W(1,153),W(1,8),-GC_3,ZERO,FK_ZERO,W(1,185))  !  count 16
      CALL VVV1P1N_2(W(1,185), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,145))  !  count 1
      CALL VVS1P1N_1(W(1,5), W(1,183), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,146))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,154), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,147))  !  count 1
      CALL VVSS1P1N_3(W(1,25), W(1,5), W(1,183), GC_34, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,148))  !  count 1
      CALL VVV1P0_1(W(1,25),W(1,5),-GC_3,ZERO,FK_ZERO,W(1,186))  !  count 12
      CALL VVV1P1N_2(W(1,186), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,149))  !  count 1
      CALL VVS1P1N_1(W(1,8), W(1,184), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     ...
     & TMP, W, AMP(1,151))  !  count 1
      CALL VVV1P0_1(W(1,25),W(1,8),-GC_3,ZERO,FK_ZERO,W(1,187))  !  count 12
      CALL VVV1P1N_2(W(1,187), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,152))  !  count 1
      CALL VVS1P1N_1(W(1,5), W(1,181), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,153))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,26), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,154))  !  count 1
      CALL VVVV2P1N_2(W(1,25), W(1,5), W(1,8), GC_35, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,155))  !  count 1
      CALL VVVV2_1(W(1,153),W(1,5),W(1,8),GC_35,MDL_MW,ZERO,W(1,188))  !  count 4
      CALL VVS1P1N_3(W(1,25), W(1,188), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,156))  !  count 1
      CALL VVSS1_3(W(1,153),W(1,5),W(1,13),GC_34,MDL_MH,ZERO,W(1,189))  !  count 1
      CALL VVSS1_3(W(1,153),W(1,5),W(1,14),GC_34,MDL_MH,ZERO,W(1,190))  !  count 1
      CALL VVSS1_3(W(1,153),W(1,5),W(1,15),GC_34,MDL_MH,ZERO,W(1,191))  !  count 1
      CALL VVSS1_3(W(1,153),W(1,5),W(1,16),GC_34,MDL_MH,ZERO,W(1,192))  !  count 1
      CALL VVS1P1N_3(W(1,25), W(1,8), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/189,190,191,192/), 
     & TMP, W, AMP(1,157))  !  count 1
      CALL VVSS1_3(W(1,153),W(1,8),W(1,13),GC_34,MDL_MH,ZERO,W(1,193))  !  count 1
      CALL VVSS1_3(W(1,153),W(1,8),W(1,14),GC_34,MDL_MH,ZERO,W(1,194))  !  count 1
      CALL VVSS1_3(W(1,153),W(1,8),W(1,15),GC_34,MDL_MH,ZERO,W(1,195))  !  count 1
      CALL VVSS1_3(W(1,153),W(1,8),W(1,16),GC_34,MDL_MH,ZERO,W(1,196))  !  count 1
      CALL VVS1P1N_3(W(1,25), W(1,5), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/193,194,195,196/), 
     & TMP, W, AMP(1,158))  !  count 1
      CALL VVVV2P1N_3(W(1,153), W(1,25), W(1,8), GC_35, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,159))  !  count 1
      CALL VVV1P1N_1(W(1,25), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/172,173,174,175/),
     & TMP, W, AMP(1,160))  !  count 1
      CALL VVS1_3(W(1,153),W(1,71),GC_72,MDL_MH,ZERO,W(1,197))  !  count 1
      CALL VVS1_3(W(1,153),W(1,72),GC_72,MDL_MH,ZERO,W(1,198))  !  count 1
      CALL VVS1_3(W(1,153),W(1,73),GC_72,MDL_MH,ZERO,W(1,199))  !  count 1
      CALL VVS1_3(W(1,153),W(1,74),GC_72,MDL_MH,ZERO,W(1,200))  !  count 1
      CALL VVS1P1N_3(W(1,25), W(1,8), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/197,198,199,200/), 
     & TMP, W, AMP(1,161))  !  count 1
      CALL VVV1P1N_3(W(1,25), W(1,8), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/176,177,178,179/),
     & TMP, W, AMP(1,162))  !  count 1
      CALL VVV1P1N_3(W(1,185), W(1,25), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,163))  !  count 1
      CALL VVS1P1N_2(W(1,25), W(1,183), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,164))  !  count 1
      CALL VVV1P1N_2(W(1,25), W(1,154), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,165))  !  count 1
      CALL VVVV2P1N_4(W(1,153), W(1,25), W(1,5), GC_35, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,166))  !  count 1
      CALL VVV1P1N_3(W(1,182), W(1,25), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,167))  !  count 1
      CALL VVS1P1N_2(W(1,25), W(1,180), GC_72, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,168))  !  count 1
      CALL VVV1P1N_2(W(1,25), W(1,169), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,169))  !  count 1
      CALL VVV1P1N_1(W(1,25), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/161,162,163,164/),
     & TMP, W, AMP(1,170))  !  count 1
      CALL VVS1_3(W(1,153),W(1,32),GC_72,MDL_MH,ZERO,W(1,201))  !  count 1
      CALL VVS1_3(W(1,153),W(1,33),GC_72,MDL_MH,ZERO,W(1,202))  !  count 1
      CALL VVS1_3(W(1,153),W(1,34),GC_72,MDL_MH,ZERO,W(1,203))  !  count 1
      CALL VVS1_3(W(1,153),W(1,35),GC_72,MDL_MH,ZERO,W(1,204))  !  count 1
      CALL VVS1P1N_3(W(1,25), W(1,5), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/201,202,203,204/), 
     & TMP, W, AMP(1,171))  !  count 1
      CALL VVV1P1N_3(W(1,25), W(1,5), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/165,166,167,168/),
     & TMP, W, AMP(1,172))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,185), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,173))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,154), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,174))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,185), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,175))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,154), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,176))  !  count 1
      CALL FFV1P1N_3(W(1,18), W(1,47), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/172,173,174,175/),
     & TMP, W, AMP(1,177))  !  count 1
      CALL FFV2_5P1N_3(W(1,18), W(1,47), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/176,177,178,179/),
     & TMP, W, AMP(1,178))  !  count 1
      CALL FFV2_1(W(1,47),W(1,153),GC_100,ZERO,FK_ZERO,W(1,205))  !  count 4
      CALL FFV2P1N_3(W(1,18), W(1,205), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     ...
     & TMP, W, AMP(1,180))  !  count 1
      CALL FFV1P0_3(W(1,18),W(1,81),GC_2,ZERO,FK_ZERO,W(1,206))  !  count 12
      CALL VVV1P1N_2(W(1,206), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,181))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,95), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,182))  !  count 1
      CALL FFV2_1(W(1,81),W(1,153),GC_100,ZERO,FK_ZERO,W(1,207))  !  count 4
      CALL FFV2P1N_3(W(1,18), W(1,207), GC_100, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,183))  !  count 1
      CALL FFV1P1N_3(W(1,18), W(1,81), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/161,162,163,164/),
     & TMP, W, AMP(1,184))  !  count 1
      CALL FFV2_5P1N_3(W(1,18), W(1,81), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/165,166,167,168/),
     & TMP, W, AMP(1,185))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,182), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,186))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,169), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,187))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,182), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,188))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,169), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     ...
     & TMP, W, AMP(1,190))  !  count 1
      CALL FFV1P0_3(W(1,18),W(1,47),GC_2,ZERO,FK_ZERO,W(1,208))  !  count 12
      CALL VVV1P1N_2(W(1,208), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,191))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,61), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/155,156,157,158/),
     & TMP, W, AMP(1,192))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,17), W(1,159), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,193))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,68), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,194))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,103), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,195))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,66), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,196))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,159), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,197))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,68), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,199))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,66), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,200))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,47),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,213
     $))  !  count 28
     ...
     & TMP, W, AMP(1,201))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,37),-GC_50,GC_58,MDL_MZ,ZERO,W(1,214))  !  count 28
     ...
     & TMP, W, AMP(1,202))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,17), W(1,170), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     ...
     & TMP, W, AMP(1,204))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,114), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,205))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,22), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,206))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,170), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     ...
     & TMP, W, AMP(1,208))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,114), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     ...
     & TMP, W, AMP(1,210))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,81),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,219
     $))  !  count 28
     ...
     & TMP, W, AMP(1,211))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,76),-GC_50,GC_58,MDL_MZ,ZERO,W(1,220))  !  count 28
      CALL VVS1P1N_3(W(1,220), W(1,24), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,212))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,187), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,213))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,26), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,214))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,187), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,215))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,26), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     ...
     & TMP, W, AMP(1,217))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,37),GC_2,ZERO,FK_ZERO,W(1,221))  !  count 16
      CALL VVV1P1N_3(W(1,221), W(1,25), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,218))  !  count 1
      CALL VVV1P1N_2(W(1,25), W(1,214), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     ...
     & TMP, W, AMP(1,220))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,76),GC_2,ZERO,FK_ZERO,W(1,222))  !  count 16
      CALL VVV1P1N_2(W(1,222), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,221))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,220), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,222))  !  count 1
      CALL VVV1P1N_3(W(1,222), W(1,25), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,223))  !  count 1
      CALL VVV1P1N_2(W(1,25), W(1,220), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     ...
     & TMP, W, AMP(1,225))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,186), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     ...
     & TMP, W, AMP(1,227))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,186), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,230))  !  count 1
      CALL VVV1P1N_2(W(1,221), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,231))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,214), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/28,29,30,31/),
     & TMP, W, AMP(1,232))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,131), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,233))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,40), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,234))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,131), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,235))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,40), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     ...
     & TMP, W, AMP(1,237))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,47),GC_2,ZERO,FK_ZERO,W(1,223))  !  count 16
      CALL VVV1P1N_3(W(1,223), W(1,39), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     & TMP, W, AMP(1,238))  !  count 1
      CALL VVV1P1N_2(W(1,39), W(1,213), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/71,72,73,74/),
     ...
     & TMP, W, AMP(1,240))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,81),GC_2,ZERO,FK_ZERO,W(1,224))  !  count 16
      CALL VVV1P1N_2(W(1,224), W(1,8), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,241))  !  count 1
      CALL VVV1P1N_1(W(1,8), W(1,219), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,242))  !  count 1
      CALL VVV1P1N_3(W(1,224), W(1,39), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     & TMP, W, AMP(1,243))  !  count 1
      CALL VVV1P1N_2(W(1,39), W(1,219), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     ...
     & TMP, W, AMP(1,245))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,130), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,246))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,78), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,247))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,130), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,248))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,78), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     ...
     & TMP, W, AMP(1,250))  !  count 1
      CALL VVV1P1N_2(W(1,223), W(1,5), -GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,251))  !  count 1
      CALL VVV1P1N_1(W(1,5), W(1,213), GC_53, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,252))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,208), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,253))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,61), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,254))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,223), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,255))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,213), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,256))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,223), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,257))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,213), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,258))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,208), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,259))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,61), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/87,88,89,90/),
     & TMP, W, AMP(1,260))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,152), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,261))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,62), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/215,216,217,218/),
     & TMP, W, AMP(1,262))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,221), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,263))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,214), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/83,84,85,86/),
     & TMP, W, AMP(1,264))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,221), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,265))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,214), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,266))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,152), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,267))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,62), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/91,92,93,94/),
     & TMP, W, AMP(1,268))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,224), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,269))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,219), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,270))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,224), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,271))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,219), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,272))  !  count 1
      CALL FFV1P1N_1(W(1,17), W(1,206), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,273))  !  count 1
      CALL FFV2_3P1N_1(W(1,17), W(1,95), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,274))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,206), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     & TMP, W, AMP(1,275))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,95), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/53,54,55,56/),
     ...
     & TMP, W, AMP(1,278))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,222), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,279))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,220), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,50,51,52/),
     & TMP, W, AMP(1,280))  !  count 1
      CALL FFV1P1N_2(W(1,18), W(1,222), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,281))  !  count 1
      CALL FFV2_5P1N_2(W(1,18), W(1,220), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,282))  !  count 1
      CALL FFV1P1N_1(W(1,2), W(1,150), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,283))  !  count 1
      CALL FFV2_3P1N_1(W(1,2), W(1,96), GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/209,210,211,212/),
     & TMP, W, AMP(1,284))  !  count 1
      CALL FFV1P1N_2(W(1,1), W(1,150), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
     & TMP, W, AMP(1,285))  !  count 1
      CALL FFV2_5P1N_2(W(1,1), W(1,96), -GC_50, GC_58, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/57,58,59,60/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $    7)   +AMP( K,198))
          ...
          AMP2(97)=AMP2(97)+AMP( K,97)*DCONJG(AMP( K,97))
          AMP2(98)=AMP2(98)+AMP( K,98)*DCONJG(AMP( K,98))
          AMP2(99)=AMP2(99)+AMP( K,99)*DCONJG(AMP( K,99))
          AMP2(100)=AMP2(100)+AMP( K,100)*DCONJG(AMP( K,100))
          AMP2(101)=AMP2(101)+AMP( K,101)*DCONJG(AMP( K,101))
          AMP2(102)=AMP2(102)+AMP( K,102)*DCONJG(AMP( K,102))
          AMP2(103)=AMP2(103)+AMP( K,103)*DCONJG(AMP( K,103))
          AMP2(104)=AMP2(104)+AMP( K,104)*DCONJG(AMP( K,104))
          AMP2(105)=AMP2(105)+AMP( K,105)*DCONJG(AMP( K,105))
          AMP2(106)=AMP2(106)+AMP( K,106)*DCONJG(AMP( K,106))
          AMP2(107)=AMP2(107)+AMP( K,107)*DCONJG(AMP( K,107))
          AMP2(108)=AMP2(108)+AMP( K,108)*DCONJG(AMP( K,108))
          ...
          AMP2(112)=AMP2(112)+AMP( K,112)*DCONJG(AMP( K,112))
          AMP2(113)=AMP2(113)+AMP( K,113)*DCONJG(AMP( K,113))
          AMP2(114)=AMP2(114)+AMP( K,114)*DCONJG(AMP( K,114))
          AMP2(115)=AMP2(115)+AMP( K,115)*DCONJG(AMP( K,115))
          AMP2(116)=AMP2(116)+AMP( K,116)*DCONJG(AMP( K,116))
          AMP2(117)=AMP2(117)+AMP( K,117)*DCONJG(AMP( K,117))
          AMP2(118)=AMP2(118)+AMP( K,118)*DCONJG(AMP( K,118))
          AMP2(119)=AMP2(119)+AMP( K,119)*DCONJG(AMP( K,119))
          AMP2(120)=AMP2(120)+AMP( K,120)*DCONJG(AMP( K,120))
          AMP2(121)=AMP2(121)+AMP( K,121)*DCONJG(AMP( K,121))
          AMP2(122)=AMP2(122)+AMP( K,122)*DCONJG(AMP( K,122))
          AMP2(195)=AMP2(195)+AMP( K,195)*DCONJG(AMP( K,195))
          AMP2(196)=AMP2(196)+AMP( K,196)*DCONJG(AMP( K,196))
          AMP2(199)=AMP2(199)+AMP( K,199)*DCONJG(AMP( K,199))
          AMP2(200)=AMP2(200)+AMP( K,200)*DCONJG(AMP( K,200))
          AMP2(201)=AMP2(201)+AMP( K,201)*DCONJG(AMP( K,201))
          AMP2(205)=AMP2(205)+AMP( K,205)*DCONJG(AMP( K,205))
          AMP2(206)=AMP2(206)+AMP( K,206)*DCONJG(AMP( K,206))
          AMP2(209)=AMP2(209)+AMP( K,209)*DCONJG(AMP( K,209))
          AMP2(210)=AMP2(210)+AMP( K,210)*DCONJG(AMP( K,210))
          AMP2(211)=AMP2(211)+AMP( K,211)*DCONJG(AMP( K,211))
          AMP2(233)=AMP2(233)+AMP( K,233)*DCONJG(AMP( K,233))
          AMP2(234)=AMP2(234)+AMP( K,234)*DCONJG(AMP( K,234))
          AMP2(235)=AMP2(235)+AMP( K,235)*DCONJG(AMP( K,235))
          AMP2(236)=AMP2(236)+AMP( K,236)*DCONJG(AMP( K,236))
          AMP2(237)=AMP2(237)+AMP( K,237)*DCONJG(AMP( K,237))
          AMP2(238)=AMP2(238)+AMP( K,238)*DCONJG(AMP( K,238))
          AMP2(239)=AMP2(239)+AMP( K,239)*DCONJG(AMP( K,239))
          AMP2(240)=AMP2(240)+AMP( K,240)*DCONJG(AMP( K,240))
          AMP2(241)=AMP2(241)+AMP( K,241)*DCONJG(AMP( K,241))
          AMP2(242)=AMP2(242)+AMP( K,242)*DCONJG(AMP( K,242))
          AMP2(243)=AMP2(243)+AMP( K,243)*DCONJG(AMP( K,243))
          AMP2(244)=AMP2(244)+AMP( K,244)*DCONJG(AMP( K,244))
          AMP2(245)=AMP2(245)+AMP( K,245)*DCONJG(AMP( K,245))
          AMP2(246)=AMP2(246)+AMP( K,246)*DCONJG(AMP( K,246))
          AMP2(247)=AMP2(247)+AMP( K,247)*DCONJG(AMP( K,247))
          AMP2(248)=AMP2(248)+AMP( K,248)*DCONJG(AMP( K,248))
          AMP2(249)=AMP2(249)+AMP( K,249)*DCONJG(AMP( K,249))
          AMP2(250)=AMP2(250)+AMP( K,250)*DCONJG(AMP( K,250))
          AMP2(251)=AMP2(251)+AMP( K,251)*DCONJG(AMP( K,251))
          AMP2(252)=AMP2(252)+AMP( K,252)*DCONJG(AMP( K,252))
          AMP2(255)=AMP2(255)+AMP( K,255)*DCONJG(AMP( K,255))
          AMP2(256)=AMP2(256)+AMP( K,256)*DCONJG(AMP( K,256))
          AMP2(257)=AMP2(257)+AMP( K,257)*DCONJG(AMP( K,257))
          AMP2(258)=AMP2(258)+AMP( K,258)*DCONJG(AMP( K,258))
          AMP2(261)=AMP2(261)+AMP( K,261)*DCONJG(AMP( K,261))
          AMP2(262)=AMP2(262)+AMP( K,262)*DCONJG(AMP( K,262))
          AMP2(267)=AMP2(267)+AMP( K,267)*DCONJG(AMP( K,267))
          AMP2(268)=AMP2(268)+AMP( K,268)*DCONJG(AMP( K,268))
          AMP2(269)=AMP2(269)+AMP( K,269)*DCONJG(AMP( K,269))
          AMP2(270)=AMP2(270)+AMP( K,270)*DCONJG(AMP( K,270))
          AMP2(271)=AMP2(271)+AMP( K,271)*DCONJG(AMP( K,271))
          AMP2(272)=AMP2(272)+AMP( K,272)*DCONJG(AMP( K,272))
          AMP2(277)=AMP2(277)+AMP( K,277)*DCONJG(AMP( K,277))
          AMP2(283)=AMP2(283)+AMP( K,283)*DCONJG(AMP( K,283))
          AMP2(284)=AMP2(284)+AMP( K,284)*DCONJG(AMP( K,284))
          AMP2(285)=AMP2(285)+AMP( K,285)*DCONJG(AMP( K,285))
          AMP2(286)=AMP2(286)+AMP( K,286)*DCONJG(AMP( K,286))
