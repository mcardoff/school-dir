...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(TMP8*(-CI*(P2(0))+CI*(P3(0)))+(V2(3)*(-CI*(TMP3)
     $ +CI*(TMP4))+V3(3)*(+CI*(TMP5)-CI*(TMP7))))
      V1(4)= DENOM*(TMP8*(-CI*(P2(1))+CI*(P3(1)))+(V2(4)*(-CI*(TMP3)
     $ +CI*(TMP4))+V3(4)*(+CI*(TMP5)-CI*(TMP7))))
      V1(5)= DENOM*(TMP8*(-CI*(P2(2))+CI*(P3(2)))+(V2(5)*(-CI*(TMP3)
     $ +CI*(TMP4))+V3(5)*(+CI*(TMP5)-CI*(TMP7))))
      V1(6)= DENOM*(TMP8*(-CI*(P2(3))+CI*(P3(3)))+(V2(6)*(-CI*(TMP3)
     $ +CI*(TMP4))+V3(6)*(+CI*(TMP5)-CI*(TMP7))))
      END
